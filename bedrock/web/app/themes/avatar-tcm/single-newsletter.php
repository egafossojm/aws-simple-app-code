...
$tc_logo = 'https://cdn.ofsys.com/T/OFSYS/H/C931/928/ARwlrl/tc-media-logo.gif';
$site_logo = 'https://cdn.ofsys.com/T/OFSYS/H/C931/997/SIMUyW/site-logo.png';
$background = '#fff';
$bgcolor = '#fff';
...
function avatar_get_the_permalink_url($url, $campaign)
{
    ...
    switch ($campaign) {
        case 'template_ie_am':
            $campaign_name = 'INT-EN-morning';
            break;
        case 'template_ie_pm':
            $campaign_name = 'INT-EN-All-afternoon';
            break;
        case 'template_ie_weekly':
            $campaign_name = 'INT-EN-saturday';
            break;
        case 'template_ie_monthly':
            $campaign_name = 'INT-EN-monthly';
            break;
        case 'template_ie_etf':
            $campaign_name = 'INT-EN-ETF';
            break;
        default:
...
switch ($newsletter_template) {
    case 'template_ie_am':
        $newsletter_template_wording = __('Your Daily AM e-newsletter and alerts', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_ie_pm':
        $newsletter_template_wording = __('Your Daily PM e-newsletter and alerts', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_ie_weekly':
        $newsletter_template_wording = __('Your Weekly e-newsletter and alerts', 'avatar-tcm');
        $prepend_date = __('Week of', 'avatar-tcm');
        break;
    case 'template_ie_monthly':
        $newsletter_template_wording = __('Your Monthly e-newsletter and alerts', 'avatar-tcm');
        $prepend_date = __('Month of', 'avatar-tcm');
        break;
    case 'template_ie_etf':
        $newsletter_template_wording = __('Special ETF Newsletter', 'avatar-tcm');
        break;
    default:
        $newsletter_template_wording = __('Your e-newsletter and alerts', 'avatar-tcm');
        break;
}
if ($newsletter_template == 'template_ie_am') {
...
<html>
<head>
	<title>IE Responsive Newsletter</title>
...
<!-- [[string CodeUnique = system.Tools.GenerateGUID();]] -->
  <table id="newsletterIE" class="body" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; height: 100%; width: 100%; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0;">
	...
	<center class="main-center" style="width: 100%; min-width: 580px; background: #D9D9D9;">
	  <!--begin top advertisement banner--> 
	  <!-- liveintend -->
				...
				<tbody>
				  <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
					<td class="wrapper" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;position:relative;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:10px 20px 0px 0px;" align="left" valign="top"><table class="six columns" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:280px;background:#fff;margin:0 auto;padding:0;" bgcolor="#fff">
						<tbody>
						  <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
							<!--main logo--><td style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 10px;" align="left" valign="top"><a target="_blank" href="<?php echo avatar_get_the_permalink_url(get_bloginfo('url'), $campaign); ?>" style="text-decoration:none;"><img src="<?php echo esc_url($site_logo); ?>" alt="" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: 260px; max-width: 260px; clear: both; display: block; border: none" width="260"></a></td><!--end main logo-->
						  </tr>
						</tbody>
					  </table></td>
		  ...
		  <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
			<td style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0;" align="left" valign="top"><table class="row" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:100%;position:relative;display:block;padding:0px;">
				<tbody>
						  ...
						  <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
							<td align="center" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#424242;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 20px;" valign="top"><center style="text-align:center;width:100%;min-width:580px;">
								<p style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center">
                                    <span style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center"><?php _e('This message was sent to', 'avatar-tcm'); ?> [[=Contact.f_EMail;]] by Investment Executive</span><br>
                   <!-- manage subscription -->
                  ...
                  <!-- end manage subscription -->
                  <!--unsubscribe link-->
           			<a href="[[=Message.Optout("en-CA");]]" class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Unsubscribe', 'avatar-tcm'); ?></a><br>
                    ...
                    <?php _e('Support :', 'avatar-tcm'); ?><a href="mailto:subs@investmentexecutive.com" class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;">subs@investmentexecutive.com</a> | <span>1-866-453-5833</span><br>
                  <a href="<?php echo esc_url(avatar_get_the_permalink_url('http://tctranscontinental.com/en/privacy-policy', $campaign)); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Privacy Policy', 'avatar-tcm'); ?></a> | <a href="<?php echo avatar_get_the_permalink_url('https://www.investmentexecutive.com/terms-of-use/', $campaign); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Terms and Conditions', 'avatar-tcm'); ?></a><br>
								</p>
								<img src="<?php echo esc_url($tc_logo); ?>" align="none" style="display: inline; outline: none; text-decoration: none; width: auto; max-width: 100%; clear: both">
							  </center></td>
						  </tr>
						</tbody>
					  </table></td>
