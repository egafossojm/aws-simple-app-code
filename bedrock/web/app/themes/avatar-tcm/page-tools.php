    ...
    include locate_template('templates/tools/component-ceplace.php');
			...
			<section class="row equal-col-md dual-col">
				<div class="col-md-8 left-content">
					<?php
        // Include Advisor Central
        //include( locate_template( 'templates/tools/component-advisorcentral.php' ) );

        // Include Webinars
        include locate_template('templates/tools/component-webinars.php');

if ($site_id != 2) {
    // Include For Your Clients
    include locate_template('templates/tools/component-foryourclients.php');
}

// Include Partners's Place
include locate_template('templates/tools/component-partnersplace.php');
?>
				</div>
