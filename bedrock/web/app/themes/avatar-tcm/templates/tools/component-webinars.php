<?php
$avatar_cat_webinars = get_field('acf_tools_webinars_link', 'option');

$wp_query_articles_arg = [
    'post_type' => 'post',
    'post_status' => 'publish',
    'posts_per_page' => 2,
    'cat' => $avatar_cat_webinars->term_id,
];
...
<div class="bloc">
	<div class="row">
		<div class="col-md-12">
			<h2 class="webinars">
				<a class="text-content__link" href="<?php echo get_category_link($avatar_cat_webinars->term_id); ?>"><?php echo wp_kses_post($avatar_cat_webinars->name); ?></a>
