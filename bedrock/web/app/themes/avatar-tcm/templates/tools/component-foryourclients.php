<?php
$avatar_catforyourclients = get_field('acf_tools_foryourclients_link', 'option');

if ($avatar_catforyourclients == null) {
    return;
}
...
$wp_query_articles_arg = [
    ...
    'post_status' => 'publish',
    'posts_per_page' => 2,
    'cat' => $avatar_catforyourclients->term_id,
];
...
<div class="bloc">
	<div class="row">
		<div class="col-md-12">
			<h2 class="fyclients">
				<a class="text-content__link" href="<?php echo get_category_link($avatar_catforyourclients->term_id); ?>"><?php echo wp_kses_post($avatar_catforyourclients->name); ?></a>
