...
?>
	...
	<fieldset name="sign-up-informations" class="row">
		...
		<div class="user-form__inputs col-md-9 col-sm-8 user-form__inputs--radio">
			...
			<input value="<?php echo esc_attr($avatar_get_user_data_di['f_BusinessAddress']); ?>" type="text" id="f_BusinessAddress" name="f_BusinessAddress" class="form-control" aria-required="true" required="required" >
			...
			<input value="<?php echo esc_attr($avatar_get_user_data_di['f_Telephone']); ?>" type="text" id="f_Telephone" name="f_Telephone" class="form-control" aria-required="true" required="required" >
		</div>
	</fieldset>
	<br>
	<div name="sign-up-informations">
		<div class="row equal-col">
			...
			<div class="col-md-9 col-sm-8 user-form__inputs--checkboxes">
				<?php $btn_message = ($current_user->roles[0] == 'newspaper') ? __('Update delivery address', 'avatar-tcm') : __('Subscribe to newspaper', 'avatar-tcm'); ?>
