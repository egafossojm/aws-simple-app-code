...
?>
      ...
      <table class="container  headline-first-block" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:inherit;width:580px;background:<?php echo esc_attr($background); ?>;margin:0 auto;padding:0;" bgcolor="<?php echo esc_attr($bgcolor); ?>">
        <tbody>
...
<?php
if ($has_ad) {
    include locate_template('templates/newsletter/newsletter_headline_ads.php');
} else {
    include locate_template('templates/newsletter/newsletter_headline_noads.php');
}?>
