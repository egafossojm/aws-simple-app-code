<table class="container headline-news-list news-list" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: inherit; width: 580px; background: #fff; margin: 0 auto; padding: 0;" bgcolor="#fff">
  <tbody>
                                  ...
                                  <tbody>
                                    <tr style="vertical-align: top; text-align: left; padding: 0;" align="left">
                                      <td style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 10px 0 0; padding: 5px 0 5px; border-bottom: 1px solid <?php echo esc_attr($site_color); ?>; <?php if (($acf_article_sponsor !== null) && ($acf_article_sponsor > 0)) {
                                        ...
                                        <!--title-->
                                        <span class="title" style="font-size: 16px;"><a href="<?php echo avatar_get_the_permalink_url(the_permalink($article_id), $campaign); ?>" style="text-decoration: none; color: <?php echo esc_attr($site_color); ?>; font-weight: bold;"><strong><?php echo wp_kses_post($post_title); ?></strong></a></span><br>
