...
/*
* Location : HomePage
* Partners Reports scheduler Component
* Displays a list of Partners Reports's campaigns
* Admin : Sale's section [Partners Reports]
*/
?>
<?php if (have_rows('acf_scheduler_partner_campaigns', 'option')) { ?>
	<?php while (have_rows('acf_scheduler_partner_campaigns', 'option')) {
	    the_row();
	...
	<?php if (! empty($avatar_sh_campaigns_articles)) {
	    $campaign_url = get_sub_field('homepage_partners_campaign_url'); ?>
	    ...
	    if ($the_query->have_posts()) {
	        ...
	        while ($the_query->have_posts()) {
	            ...
	            $the_query->the_post();
	            $col_conditional_width = (has_post_thumbnail()) ? 'col-md-7 col-sm-7 col-xs-12' : 'col-md-12'; ?>
