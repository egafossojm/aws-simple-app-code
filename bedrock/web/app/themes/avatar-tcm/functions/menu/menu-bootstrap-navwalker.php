        ...
        public function start_el(&$output, $item, $depth = 0, $args = [], $id = 0)
        {
            ...
            if (strcasecmp($item->attr_title, 'divider') === 0 && $depth === 1) {
                ...
                */
                ...
                $item_output .= ($args->has_children && $depth === 0) ? '</a> <a href="#" class="visible-xs visible-sm visible-md custom-caret" data-toggle="dropdown"></a>' : '</a>';
...
/**
 * Add a custom link (SEARCH) to the end of a specific menu that uses the wp_nav_menu() function
 */
add_filter('wp_nav_menu_items', 'avatar_add_search_button_menu', 10, 2);
function avatar_add_search_button_menu($items, $args)
{
    if ($args->theme_location == 'header_main') {
        $items .= '<li><button class="search-trigger search-trigger--menu bobo visible-lg" data-target="#search-box" data-toggle="collapse">                             
        				<i class="fa fa-search" aria-hidden="true"></i>
        				<span class="sr-only">'.__('Search', 'avatar-tcm').'></span>
        			</button></li>';
    }
