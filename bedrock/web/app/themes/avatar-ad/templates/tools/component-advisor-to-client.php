<?php
$avatar_cat_advisortoclient = get_field('acf_advisor_to_client_link', 'option');

if ($avatar_cat_advisortoclient == null) {
    return;
}
...
$wp_query_articles_arg = [
    ...
    'post_status' => 'publish',
    'posts_per_page' => 2,
    'cat' => $avatar_cat_advisortoclient->term_id,
];
...
<div class="bloc">
	<div class="row">
		<div class="col-md-12">
			<h2 class="letters">
				<a class="text-content__link" href="<?php echo get_category_link($avatar_cat_advisortoclient->term_id); ?>"><?php echo wp_kses_post($avatar_cat_advisortoclient->name); ?></a>
