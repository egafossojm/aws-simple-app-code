    ...
    include locate_template('templates/tools/component-ceplace.php');
			...
			<section class="row equal-col-md dual-col">
				<div class="col-md-8 left-content">
					<?php
        // Include Advisor to go
        include locate_template('templates/tools/component-advisor-to-go.php');

// Include Advisor to client
$slug_name = 'modeles-de-lettres';
include locate_template('templates/tools/component-advisor-to-client.php');

// Include retirement resourse center
include locate_template('templates/tools/component-retirement-resource-center.php');
?>
				</div>
