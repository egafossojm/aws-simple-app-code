...
$tc_logo = 'https://cdn.ofsys.com/T/OFSYS/H/C1024/2218/ln42ve/tc-media-logo.gif';
$site_logo = 'https://cdn.ofsys.com/T/OFSYS/H/C1024/2525/oMUwjk/site-logo-advisor.png';
$background = '#fff';
$bgcolor = '#fff';
...
switch ($newsletter_template) {
    case 'template_ad_ambulletin':
        $newsletter_template_wording = __('AM Bulletin', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_ad_midday':
        $newsletter_template_wording = __('Mid-Day Bulletin', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_ad_pmbulletin':
        $newsletter_template_wording = __('PM Bulletin', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_ad_weekinreview':
        $newsletter_template_wording = __('Week in Review', 'avatar-tcm');
        $prepend_date = __('Week of', 'avatar-tcm');
        break;
    case 'template_ad_bestofthemonth':
        $newsletter_template_wording = __('Best of the Month', 'avatar-tcm');
        $prepend_date = __('Month of', 'avatar-tcm');
        break;
    case 'template_ad_breakingnews':
        $newsletter_template_wording = __('Special Edition', 'avatar-tcm');
        break;
    case 'template_ad_togo':
        $newsletter_template_wording = __('Advisor To Go', 'avatar-tcm');
        break;
    default:
        $newsletter_template_wording = __('Your e-newsletter and alerts', 'avatar-tcm');
        break;
}
if ($newsletter_template == 'template_ad_ambulletin') {

}
$newsletter_block_array = $all_fields['acf_newsletter_block'];

$user_profile_page = get_field('acf_profile_newsletters', 'option');
$user_profile_page_url = 'https://tc.advisor.ca/T/WF/4477/MfT5US/Update/CL[[=Contact.idContact;]]/[[=Contact.clKey;]]/Form.ofsys';
?>
...
<html>
<head>
  <title>AD Responsive Newsletter</title>
...
@media (max-width: 600px) {
  ...
  #newsletterAD .bigbox-cell {
    text-align: center;
  }
  #newsletterAD .bigbox-cell img {
    display: inline;
  }
  #newsletterAD .date-info {
...
.sponsor-bg {
  ...
  <table id="newsletterAD" class="body" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; height: 100%; width: 100%; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0;">
    <tbody>
          ...
          <td class="wrapper last" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;position:relative;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:10px 0px 0px;" align="left" valign="top"><table class="six columns" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:280px;background:#fff;margin:0 auto;padding:0;" bgcolor="#fff">
            <tbody>
              ...
              <td class="date-info text-pad" style="vertical-align:middle;font-size:12px;word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;text-align:right;color:#222;font-family:Arial;font-weight:normal;line-height:19px;margin:0;padding:0px 20px 10px 10px;" align="right" valign="middle">
                <!--date label-->
                <span class="date-label"><?php echo wp_kses_post($prepend_date).' '.date_i18n('F d, Y', strtotime($send_date)); ?></span><!--end date label--><br>
                ...
                <a class="blurb-label" style="font-size:12px;color:<?php echo esc_attr($site_color); ?>;text-decoration:none;" href="<?php echo esc_url(avatar_get_the_permalink_url(get_bloginfo('url'), $campaign)); ?>"><?php _e('Go&nbsp;to&nbsp;website', 'avatar-tcm'); ?></a><!--end go to web version link--><br>
                  <!-- manage subscription -->
                  <a href="<?php echo $user_profile_page_url; ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:none;"><?php _e('Manage subscription', 'avatar-tcm'); ?></a>
            ...
            <tbody>
              ...
              <td align="center" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#424242;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 20px;" valign="top"><center style="text-align:center;width:100%;min-width:580px;">
                <p style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center">
                   <span style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center"><?php _e('This message was sent to', 'avatar-tcm'); ?> [[=Contact.f_EMail;]] by Advisor’s Edge</span><br>
                   <!-- manage subscription -->
                  <a href="<?php echo $user_profile_page_url; ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Manage subscription', 'avatar-tcm'); ?></a> |
                  <!-- end manage subscription -->
                  <!--unsubscribe link-->
           			<a href="https://tc.advisor.ca/T/WF/4477/MfT5US/Subscription/CL[[=Contact.idContact;]]/[[=Contact.clKey;]]/Form.ofsys" class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Unsubscribe', 'avatar-tcm'); ?></a><br>
                    ...
                    <?php _e('Support :', 'avatar-tcm'); ?><a href="mailto:contact@tc.advisor.ca" class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;">contact@tc.advisor.ca</a> | <span>1-866-453-5833</span><br>
                  <a href="<?php echo esc_url(avatar_get_the_permalink_url('http://tctranscontinental.com/en/privacy-policy', $campaign)); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Privacy Policy', 'avatar-tcm'); ?></a> | <a href="<?php echo avatar_get_the_permalink_url('https://www.advisor.ca/terms-of-service/', $campaign); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Terms and Conditions', 'avatar-tcm'); ?></a><br>
                  </p>
