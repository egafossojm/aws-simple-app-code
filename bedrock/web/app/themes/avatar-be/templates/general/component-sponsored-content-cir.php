<div class="col-sm-12">
    <div class="bloc-title">
        <span class="bloc-title__text">
            <?php _e('Featured Partner Content', 'avatar-tcm'); ?>
        </span>
    </div>
    <?php
            ...
            <div class="content-area">
                <main class="content-wrapper">
                    <?php
                        ...
                        <p>No Partner Series content found.</p>
                    <?php } ?>
                </main>
            </div>
        </div>
...
include locate_template('templates/general/component-partners-series-cir.php');
            ...
            //include(locate_template('templates/general/component-plansponsorguidebooks-cir.php'));
