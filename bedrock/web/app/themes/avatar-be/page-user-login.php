		...
		<div id="primary" class="content-area">
	        ...
	        ?>
				...
				<section class="row row--no-margin">
					<aside class="col-md-4 col-md-push-8 sign-in-box">
	                    ...
	                    if (get_the_id() == get_field('acf_page_password_reset', 'option')->ID) {
	                        ...
	                        include locate_template('../avatar-be/templates/user/form-sign-in.php');
	                    }
	        ?>
					...
					<div class="col-md-8 col-md-pull-4 sign-in-benefit-content">
						<?php the_content(); ?>
					</div>
