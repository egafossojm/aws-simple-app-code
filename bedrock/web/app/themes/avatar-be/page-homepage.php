...
$arr_m32_vars = [
    ...
    // 'sizes'			=> '[ "fluid",[728,90], [970,250], [980,200], [300,1050], [300,600], [300,250] ]',
    // 'sizeMapping' 	=> '[ [[768,0], [[728,90]]], [[1024, 0], ["fluid",[728,90],[970,250],[980,200]], [[0,0], [[320,50], [300,250], [300,600]]], [[768,0], [[300,250]]], [[1024, 0], [[300,1050], [300,600], [300,250]]]] ]',
];
$arr_avt_vars = [
    'class' => 'leaderboard',
];
...
include 'component-inside-track.php';

if ($site_id == 7) {
    include 'component-inside-track-cir.php';
}
...
?>
						...
						<div class="col-md-6 col-sm-6">
							...
							<?php
if (($site_id != 5) && ($site_id != 4) && ($site_id != 6)) {
    $arr_m32_vars = [
        'kv' => [
            'pos' => [
                'btf',
