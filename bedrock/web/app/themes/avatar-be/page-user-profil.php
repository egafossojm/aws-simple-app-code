...
if (isset($_REQUEST['update_user_profile'])) {
    ...
    if (empty($avatar_get_user_data_di['f_CompanyName'])) {
...
if (isset($_REQUEST['update_user_newspaper'])) {
    ...
    $avatar_get_user_data_di['f_Address1'] = sanitize_text_field(trim(stripslashes_deep($avatar_get_user_data_di['f_Address1'])));
    $avatar_get_user_data_di['f_Address2'] = sanitize_text_field(trim(stripslashes_deep($avatar_get_user_data_di['f_Address2'])));
    ...
    $avatar_get_user_data_di['f_Province'] = sanitize_text_field(trim(stripslashes_deep($avatar_get_user_data_di['f_Province'])));
    $avatar_get_user_data_di['f_PostalCode'] = sanitize_text_field(trim(strtoupper($avatar_get_user_data_di['f_PostalCode'])));
    $avatar_get_user_data_di['f_TelephoneNumber'] = sanitize_text_field(trim(stripslashes_deep($avatar_get_user_data_di['f_TelephoneNumber'])));
    $avatar_get_user_data_di['optin_optin_BECA_Print'] = true;

    if (empty($avatar_get_user_data_di['f_Address1'])) {
        $errors->add('f_Address1', __('Field "Business address" is mandatory', 'avatar-tcm'));
    }
    ...
    if (empty($avatar_get_user_data_di['f_TelephoneNumber'])) {
    ...
    if (($avatar_get_user_data_di['f_Country'] == 'Canada' || $avatar_get_user_data_di['f_Country'] == 'United States') && ($avatar_get_user_data_di['f_Province'] == '')) {
        $errors->add('f_Province', __('Field "Province" is mandatory', 'avatar-tcm'));
    }
    ...
    if ($avatar_get_user_data_di['f_Country'] == 'Canada') {
        ...
        if (! $is_valid) {
            $errors->add('f_Province', __('Invalid Postal Code', 'avatar-tcm'));
        }
