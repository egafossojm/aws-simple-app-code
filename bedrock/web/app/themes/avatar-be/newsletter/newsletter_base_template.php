...
if (! $is_alert && $has_ad && ! $has_ads_already) {

    // if ($article_count == 3 || $article_count == 2 || $article_count == 1) {
...
// TODO mschmit - with time this part can be refactored, we can replace all the article_block logique and remove the ..._ads template.
if (($article_count > 0) || ! $has_ad || $is_alert || strcmp($previous_type, 'acf_newsletter_main_section_title') === 0 || $has_ads_already) { ?>
  <table class="container" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:inherit;width:728px;background:<?php echo esc_attr($background); ?>;margin:0 auto;padding:0;" bgcolor="<?php echo esc_attr($bgcolor); ?>">
    <tbody>
      <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
        <td style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:10px 0;" align="left" valign="top">
            ...
            <tbody>
                ...
                <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
                  <td class="wrapper last" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;position:relative;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 0px;" align="left" valign="top">
                    <table class="twelve columns" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:728px;margin:0 auto;padding:0;">
                      <tbody>
                        <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
                          <td style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 20px;" align="left" valign="top">
              ...
              <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
                <td style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0;" align="left" valign="top">
                  <table class="row text-pad multimedia-news" style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:100%;position:relative;display:block;padding:0px;">
                    <tbody>
                      <?php foreach ($first_article_block as $article) {
                        ...
                        <?php if (! $show_thumbnail || empty($the_article_thumbnail_url)) { ?>
                          <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
                            <td class="text-pad" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 10px 5px;" align="left" valign="top">
                                ...
                                <tbody>
                                  <tr style="vertical-align:top;text-align:left;padding:0;" align="left">
                                    <td class="first" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#222;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;border-top-style:none;border-top-width:1px;border-top-color:#D9D9D9;margin:10px 0 0;padding:0px 0 5px; <?php if (($acf_article_sponsor !== null) && ($acf_article_sponsor > 0)) {
                                      ...
                                      <br>
                                      <span class="title" style="font-size:18px;"><a href="<?php echo avatar_get_the_permalink_url($article_permalink, $campaign); ?>" style="text-decoration:none;color:<?php echo esc_attr($title_color); ?>;font-weight:700;"><strong><?php echo wp_kses_post($post_title); ?></strong></a></span><br>
...
<?php if (! $is_alert && $has_ad && ! $has_ads_already) {
    include 'newsletter_ads.php';
    $has_ads_already = true;
} ?>
