...
$article_origin = get_category_origin($thiscat);
							...
							<?php if ($i > 3) {
								...
								<div class="col-sm-6 <?php echo esc_attr($conditional_col); ?> js-regular-listing">
									<div id="post-<?php the_ID(); ?>" <?php post_class('text-content text-content--border-top '); ?>>
										<?php avatar_display_sponsor_header_title($curr_post_id); ?>
										<?php
							        $cir_ad_is_active = false;
							    $current_category_object = get_queried_object();
							    $current_category_slug = $current_category_object->slug;
							    if ($i === 4 && $current_category_slug == 'canadian-investment-review' && $cir_ad_is_active) {
							        $cir_ad_url = 'https://www.benefitscanada.com/canadian-investment-review/canadian-investment-review-partner-content/seeking-protection-against-rising-interest-rates/?itm_source=cir-website&itm_medium=native-homepage-feature&itm_campaign=dec-cir-nhf-russell&itm_term=sponsored&itm_content=landing-page-russell';
							        $cir_ad_surtitle = 'SPONSORED BY FTSE RUSSELL';
							        $cir_ad_title = 'Seeking protection against rising interest rates';
							        $cir_ad_text = 'Since the last round of G7 central bank interest-rate policy increases, market expectations have adjusted to the notion of ‘higher-for-longer’ in relation to inflation and short-term interest rates – particularly in Europe.';
							        $cir_ad_image = 'https://www.benefitscanada.com/wp-content/uploads/sites/7/2023/11/CIR-FTSE-Russell-Native-Article3-HP-image-250x188-.png';
							        ?>
											<style>
												.native-box {
											...
											<div class="native-box">
												<div style="width:60%;">
													<a class="sponsored-label" href="<?php echo $cir_ad_url; ?>"><?php echo $cir_ad_surtitle; ?></a>
													<a class="article-title" href="<?php echo $cir_ad_url; ?>"><?php echo $cir_ad_title; ?></a>
												</div>

												<div class="native-img-container">
													<a href="<?php echo $cir_ad_url; ?>" style="width: 126px;height: 94px;" class="text-right">
														<img style="height: 100%;  width: 100%;  object-fit: cover;" src="<?php echo $cir_ad_image; ?>" />
													</a>
												</div>

												<div style="width:100%; margin-top:12px">
													<p class="native-box-preview-text"><?php echo $cir_ad_text; ?></p>
												</div>
											</div>
										<?php
							    } else {
...
<aside class="col-md-4 primary">
    ...
    if ($is_parent) { //if this is the parent category page, insert these components in first aside bloc
        ...
        get_correct_banner_ads([$thiscat], $site_id, $id, $wp_query, $arr_m32_vars, $arr_avt_vars);
	...
	<?php } else { //if this is NOT the parent (sub-category) insert these components in aside bloc
	    ...
	    get_correct_banner_ads([get_category($parent)], $site_id, $id, $wp_query, $arr_m32_vars, $arr_avt_vars);
