...
/**
 * Template Name: Special Reports : IndexPage
 *
 * This is the template that displays In Special Reports section
 *
...
if (is_array($avatar_featured_indepth_options)) {
    ...
    new WP_Error('empty', __('In Special Reports Options are empty', 'avatar-tcm'));
}
			...
			<section class="row equal-col-md">
				<div class="col-md-8 left-content">
					<h1 class="bloc-title bloc-title--no-margin-bottom">
						...
						<span><?php _e('Special Reports', 'avatar-tcm'); ?></span>
					</h1>
					<div>
						<?php
