...
$site_logo = 'https://cdn.ofsys.com/T/OFSYS/H/C1024/2524/AEKFIN/site-logo-conseiller.png';
$background = '#fff';
$bgcolor = '#fff';
...
function avatar_add_utm_to_url($url, $campaign)
{
    switch ($campaign) {
        ...
        case 'template_co_weekinreview':
            $campaign_name = 'Palmares_Semaine';
            break;
...
switch ($newsletter_template) {
    case 'template_co_ambulletin':
        $newsletter_template_wording = __('Vos nouvelles du matin', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_co_pmbulletin':
        $newsletter_template_wording = __('Vos nouvelles du soir', 'avatar-tcm');
        $prepend_date = date_i18n('l', strtotime($send_date));
        break;
    case 'template_co_weekinreview':
        $newsletter_template_wording = __('Vos nouvelles préférées de la semaine', 'avatar-tcm');
        $prepend_date = __('Week of', 'avatar-tcm');
        break;
    case 'template_co_endirect':
        $newsletter_template_wording = __('Gestionnaires en direct', 'avatar-tcm');
        $prepend_date = '';
        break;
    case 'template_co_specialoffers':
...
if ($newsletter_template == 'template_co_ambulletin') {

}
$newsletter_block_array = $all_fields['acf_newsletter_block'];

$user_profile_page = get_field('acf_profile_newsletters', 'option');
$user_profile_page_url = 'https://tc.conseiller.ca/T/WF/4556/Ou39Fd/Update/CL[[=Contact.idContact;]]/[[=Contact.clKey;]]/Form.ofsys';
...
<html>
<head>
  <title>CO Responsive Newsletter</title>
...
@media (max-width: 600px) {
  ...
  #newsletterCO .bigbox-cell {
    text-align: center;
  }
  #newsletterCO .bigbox-cell img {
    display: inline;
  }
  #newsletterCO .date-info {
...
.custom-html-bloc a:link,
  ...
  <table id="newsletterCO" class="body" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; height: 100%; width: 100%; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0;">
    <tbody>
            ...
            <tbody>
              ...
              <td align="center" style="word-break:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse!important;vertical-align:top;text-align:left;color:#424242;font-family:Arial;font-weight:normal;line-height:19px;font-size:14px;margin:0;padding:0px 0px 20px;" valign="top"><center style="text-align:center;width:100%;min-width:580px;">
                <p style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center">
                   <span style="text-align:center;font-size:11px;line-height:17px;font-family:Arial;font-weight:normal;margin:0 0 10px;padding:0 35px;" align="center"><?php _e('This message was sent to', 'avatar-tcm'); ?>  [[=Contact.f_EMail;]] par Conseiller</span><br>
                   <!-- manage subscription -->
                  ...
                  <!-- end manage subscription -->
                  <!--unsubscribe link-->
                <a href="https://tc.conseiller.ca/T/WF/4556/Ou39Fd/Subscription/CL[[=Contact.idContact;]]/[[=Contact.clKey;]]/Form.ofsys" class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Unsubscribe', 'avatar-tcm'); ?></a><br>
                    ...
                    <?php _e('Support :', 'avatar-tcm'); ?><a href="mailto:contact@tc.conseiller.ca  " class="blurb-label" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;">contact@tc.conseiller.ca</a> | <span>1-866-517-1086</span><br>
                  <a href="<?php echo esc_url(avatar_get_the_permalink_url('https://tctranscontinental.com/fr/politique-sur-la-vie-privee?p_p_id=82&p_p_lifecycle=1&p_p_state=normal&p_p_mode=view&_82_struts_action=/language/view&_82_redirect=/privacy-policy&languageId=fr_CA', $campaign)); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Privacy Policy', 'avatar-tcm'); ?></a> | <a href="<?php echo avatar_get_the_permalink_url('https://www.conseiller.ca/conditions/', $campaign); ?>" style="color:<?php echo esc_attr($site_color); ?>;text-decoration:underline;"><?php _e('Terms and Conditions', 'avatar-tcm'); ?></a><br>
                 </p>
