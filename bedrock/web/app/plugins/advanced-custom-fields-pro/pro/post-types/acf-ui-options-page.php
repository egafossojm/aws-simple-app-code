...
if (! class_exists('ACF_UI_Options_Page')) {
    ...
    class ACF_UI_Options_Page extends ACF_Internal_Post_Type
    {
        ...
        public function __construct()
        {
            ...
            add_action('acf/init', [$this, 'register_ui_options_pages'], 6);
            add_action('acf/include_options_pages', [$this, 'include_json_options_pages']);
        }
        ...
        public function register_ui_options_pages()
        {
            ...
            foreach ($this->get_posts(['active' => true]) as $options_page) {
                $options_page = $this->get_options_page_args($options_page);

                if (empty($options_page['parent_slug']) || $options_page['parent_slug'] === 'none') {
        ...
        public function ajax_validate_values()
        {
            ...
            $options_pages = is_array($options_pages) ? $options_pages : [];
        ...
        {
            if (isset($post['parent_slug']) && $post['parent_slug'] !== 'none') {
        ...
        public function setup_local_json()
        {
            ...
            // Event listeners.
            add_action('acf/update_ui_options_page', [$local_json, 'update_internal_post_type']);
            add_action('acf/untrash_ui_options_page', [$local_json, 'update_internal_post_type']);
            add_action('acf/trash_ui_options_page', [$local_json, 'delete_internal_post_type']);
            add_action('acf/delete_ui_options_page', [$local_json, 'delete_internal_post_type']);
        }
