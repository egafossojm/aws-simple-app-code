...
if (! class_exists('acf_field_gallery')) {
    ...
    class acf_field_gallery extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            // actions
            add_action('wp_ajax_acf/fields/gallery/get_attachment', [$this, 'ajax_get_attachment']);
            add_action('wp_ajax_nopriv_acf/fields/gallery/get_attachment', [$this, 'ajax_get_attachment']);

            add_action('wp_ajax_acf/fields/gallery/update_attachment', [$this, 'ajax_update_attachment']);
            add_action('wp_ajax_nopriv_acf/fields/gallery/update_attachment', [$this, 'ajax_update_attachment']);

            add_action('wp_ajax_acf/fields/gallery/get_sort_order', [$this, 'ajax_get_sort_order']);
            add_action('wp_ajax_nopriv_acf/fields/gallery/get_sort_order', [$this, 'ajax_get_sort_order']);
        }
