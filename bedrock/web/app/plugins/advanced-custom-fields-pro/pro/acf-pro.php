...
if (! class_exists('acf_pro')) {
    ...
    class acf_pro
    {
        ...
        public function __construct()
        {
            ...
            add_action('acf/init_internal_post_types', [$this, 'register_ui_options_pages']);
            add_action('acf/include_fields', [$this, 'include_options_pages']);
            ...
            add_action('acf/in_admin_header', [$this, 'maybe_show_license_status_error']);
            add_action('acf/internal_post_type/current_screen', [$this, 'invalid_license_redirect']);
            add_action('acf/internal_post_type_list/current_screen', [$this, 'invalid_license_redirect_notice']);

            // Add filters.
            add_filter('posts_where', [$this, 'posts_where'], 10, 2);
            add_filter('acf/internal_post_type/admin_body_classes', [$this, 'admin_body_classes']);
            add_filter('acf/internal_post_type_list/admin_body_classes', [$this, 'admin_body_classes']);
        }
        ...
        public function register_assets()
        {
            ...
            // Register scripts.
            wp_register_script('acf-pro-input', acf_get_url("assets/build/js/pro/acf-pro-input{$min}.js"), ['acf-input'], $version);
            wp_register_script('acf-pro-field-group', acf_get_url("assets/build/js/pro/acf-pro-field-group{$min}.js"), ['acf-field-group'], $version);
            wp_register_script('acf-pro-ui-options-page', acf_get_url("assets/build/js/pro/acf-pro-ui-options-page{$min}.js"), ['acf-input'], $version);

            // Register styles.
            wp_register_style('acf-pro-input', acf_get_url('assets/build/css/pro/acf-pro-input.css'), ['acf-input'], $version);
            wp_register_style('acf-pro-field-group', acf_get_url('assets/build/css/pro/acf-pro-field-group.css'), ['acf-input'], $version);
        ...
        public function maybe_show_license_status_error()
        {
            ...
            if (acf_pro_is_updates_page_visible() && ! empty($manage_url) && acf_request_arg('page') !== 'acf-settings-updates') {
                $manage_link = sprintf(
                    '<a href="%1$s">%2$s</a>',
                    esc_url($manage_url),
        ...
        {
            if (! in_array($post_type, ['acf-field-group', 'acf-ui-options-page'], true)) {
                return;
            }
        ...
        public function invalid_license_redirect_notice(string $post_type)
        {
            ...
            } elseif ($post_type === 'acf-ui-options-page') {
