...
if (! class_exists('ACF_Updates')) {
    ...
    class ACF_Updates
    {
         ...
         * @param  bool  $force_check  Bypasses cached result. Defaults to false.
         ...
         * @param  int  $min  The minimum expiration limit. Default 3 hours.
         * @param  int  $max  The maximum expiration limit. Default 7 days.
         * @return int
         */
