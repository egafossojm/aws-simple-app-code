...
if (! class_exists('ACF_Admin_UI_Options_Page')) {
    ...
    class ACF_Admin_UI_Options_Page extends ACF_Admin_Internal_Post_Type
    {
        ...
        {
            add_action('wp_ajax_acf/create_options_page', [$this, 'ajax_create_options_page']);
            add_action('acf/field_group/admin_enqueue_scripts', [$this, 'add_js_parent_choices']);
            parent::__construct();
        }
        ...
        public function admin_head()
        {
            ...
            // metaboxes.
            add_meta_box('acf-basic-settings', __('Basic Settings', 'acf'), [$this, 'mb_basic_settings'], 'acf-ui-options-page', 'normal', 'high');
            add_meta_box('acf-advanced-settings', __('Advanced Settings', 'acf'), [$this, 'mb_advanced_settings'], 'acf-ui-options-page', 'normal', 'high');
            ...
            add_filter('get_user_option_screen_layout_acf-ui-options-page', [$this, 'screen_layout'], 10, 1);
            add_filter('get_user_option_metaboxhidden_acf-ui-options-page', [$this, 'force_basic_settings'], 10, 1);
            add_filter('get_user_option_closedpostboxes_acf-ui-options-page', [$this, 'force_basic_settings'], 10, 1);
            add_filter('get_user_option_closedpostboxes_acf-ui-options-page', [$this, 'force_advanced_settings'], 10, 1);
        ...
        public function force_basic_settings($hidden_metaboxes)
        {
            ...
            return array_diff($hidden_metaboxes, ['acf-basic-settings']);
        }
        ...
        public function force_advanced_settings($hidden_metaboxes)
        {
            ...
            return array_diff($hidden_metaboxes, ['acf-advanced-settings']);
        }
         ...
         * @since 6.2
         *
         * @param  int  $post_id  The post ID of a current ACF UI options page used to prevent selection of itself as a child.
         * @return array
         */
        public function get_parent_page_choices(int $post_id = 0)
        {
            ...
            $acf_parent_page_choices = ['None' => ['none' => __('No Parent', 'acf')]];
            $self_slug = false;
