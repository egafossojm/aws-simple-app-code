...
if (! class_exists('acf_admin_options_page')) {
    ...
    class acf_admin_options_page
    {
        ...
        public function admin_menu()
        {
            ...
            foreach ($pages as $page) {
                ...
                if (empty($page['parent_slug'])) {
                    $slug = add_menu_page($page['page_title'], $page['menu_title'], $page['capability'], $page['menu_slug'], [$this, 'html'], $page['icon_url'], $page['position']);
                    // child
                } else {
                    $slug = add_submenu_page($page['parent_slug'], $page['page_title'], $page['menu_title'], $page['capability'], $page['menu_slug'], [$this, 'html'], $page['position']);
                }
        ...
        public function admin_load()
        {
            ...
            if (acf_verify_nonce('options')) {
                ...
                if (acf_validate_save_post(true)) {
                    ...
                    // redirect
                    wp_safe_redirect(add_query_arg(['message' => '1']));
                    exit;
                }
            }
        ...
        public function admin_head()
        {
            ...
            // add submit div
            add_meta_box('submitdiv', __('Publish', 'acf'), [$this, 'postbox_submitdiv'], 'acf_options_page', 'side', 'high');
