...
if (! class_exists('ACF_Admin_Updates')) {
    ...
    class ACF_Admin_Updates
    {
         ...
         * @return void
         */
        public function display_wp_error($wp_error)
        {
         ...
         * @return string
         */
        public function get_changelog_changes($changelog = '', $version = '')
        {
        ...
        public function admin_menu()
        {
            ...
            // Add submenu.
            $page = add_submenu_page('edit.php?post_type=acf-field-group', __('Updates', 'acf'), __('Updates', 'acf'), acf_get_setting('capability'), 'acf-settings-updates', [$this, 'html']);
