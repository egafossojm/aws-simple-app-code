 ...
 */
function acf_get_post_stati($args = [])
{
 ...
 */
function acf_get_pretty_post_statuses($post_statuses = [])
{
 ...
 * @since  6.2.2
 *
 * @return bool Returns true if the current screen is an ACF admin screen.
 */
 ...
 * @since 6.2.4
 *
 * @return bool true if we're in a multisite install and not on the main site
 */
 ...
 * @since 6.2.4
 *
 * @return bool true if we're in a multisite install and on the main site
 */
