 ...
 * @param  string  $selector  The field name or key.
 * @param  mixed  $post_id  The post_id of which the value is saved against.
 * @param  bool  $format_value  Enable formatting of value. Default true.
 * @return void
 */
...
{
    $escaped = get_option('acf_escaped_html_log', []);

    return is_array($escaped) ? $escaped : [];
}
 ...
 */
function _acf_update_escaped_html_log($escaped = [])
{
 ...
 * @param  bool  $escape_html  Should the field return a HTML safe formatted value if $format_value is true.
 ...
 *
 * @param  mixed  $post_id  The post_id of which the value is saved against.
 * @param  bool  $format_value  Whether or not to format the field value.
 * @param  bool  $escape_html  Should the field return a HTML safe formatted value if $format_value is true.
 ...
 * @param  mixed  $post_id  The post_id of which the value is saved against.
 * @param  bool  $format_value  Whether or not to format the field value.
 * @param  bool  $load_value  Whether or not to load the field value.
 * @param  bool  $escape_html  Should the field return a HTML safe formatted value if $format_value is true.
 ...
 * @param  bool  $format_value  Enable formatting of value. When false, the field value will be escaped at this level with `acf_esc_html`. Default true.
 * @return void
 */
 ...
 * @param  bool  $format_value  Whether to format the field value.
 * @param  bool  $load_value  Whether to load the field value.
 * @param  bool  $escape_html  Should the field return a HTML safe formatted value.
 * @return mixed
 */
