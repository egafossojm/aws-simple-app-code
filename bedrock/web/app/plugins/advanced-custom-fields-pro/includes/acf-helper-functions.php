 ...
 * @since 6.2
 *
 * @return bool True if the current install is ACF PRO
 */
function acf_is_pro()
{
 ...
 * @since 6.3
 *
 * @return bool True if the current install version contains a dash, indicating a alpha, beta or RC release.
 */
 ...
 * @since 6.3
 *
 * @return string|bool The (string) version of ACF when it was first activated, or false (boolean) if the version could not be determined.
 */
