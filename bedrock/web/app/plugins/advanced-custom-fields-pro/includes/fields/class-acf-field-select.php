...
if (! class_exists('acf_field_select')) {
    ...
    class acf_field_select extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            // ajax
            add_action('wp_ajax_acf/fields/select/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/select/query', [$this, 'ajax_query']);
        }
        ...
        public function get_ajax_query($options = [])
        {
            ...
            $shortcut = apply_filters('acf/fields/select/query', [], $options);
