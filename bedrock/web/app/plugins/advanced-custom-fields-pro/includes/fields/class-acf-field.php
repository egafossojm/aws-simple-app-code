...
if (! class_exists('acf_field')) {
    ...
    class acf_field
    {
         ...
         * @param  int  $priority  The priority to add the filter on.
         * @param  int  $accepted_args  The number of args to pass to the function.
         * @return void
         */
         ...
         * @param  int  $priority  The priority to add the action on.
         * @param  int  $accepted_args  The number of args to pass to the function.
         * @return void
         */
