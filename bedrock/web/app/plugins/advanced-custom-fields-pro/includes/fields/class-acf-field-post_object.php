...
if (! class_exists('acf_field_post_object')) {
    ...
    class acf_field_post_object extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            // extra
            add_action('wp_ajax_acf/fields/post_object/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/post_object/query', [$this, 'ajax_query']);
            add_filter('acf/conditional_logic/choices', [$this, 'render_field_post_object_conditional_choices'], 10, 3);
        }
         ...
         * @return array|bool The AJAX response array, or false on failure.
         */
         ...
         * @param  int  $is_search  An int-as-boolean value for whether we're performing a search.
         * @param  bool  $unescape  Should we return an unescaped post title.
        ...
        public function update_value($value, $post_id, $field)
        {
            ...
            // Bail early if no value.
            if (empty($value)) {
                acf_update_bidirectional_values([], $post_id, $field);
         ...
         * @param  int|string  $post_id  The post ID being queried.
         * @param  array  $field  The field array.
         * @return array
         */
