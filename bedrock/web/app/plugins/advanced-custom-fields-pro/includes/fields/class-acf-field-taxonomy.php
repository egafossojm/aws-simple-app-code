...
if (! class_exists('acf_field_taxonomy')) {
    ...
    class acf_field_taxonomy extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            acf_add_filter_variations('acf/fields/taxonomy/query', ['name', 'key'], 1);
            acf_add_filter_variations('acf/fields/taxonomy/result', ['name', 'key'], 2);

            // ajax
            add_action('wp_ajax_acf/fields/taxonomy/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/taxonomy/query', [$this, 'ajax_query']);
            add_action('wp_ajax_acf/fields/taxonomy/add_term', [$this, 'ajax_add_term']);
            add_filter('acf/conditional_logic/choices', [$this, 'render_field_taxonomy_conditional_choices'], 10, 3);
         ...
         * @return string
         */
        public function get_term_title($term, $field, $post_id = 0, $unescape = false)
        {
