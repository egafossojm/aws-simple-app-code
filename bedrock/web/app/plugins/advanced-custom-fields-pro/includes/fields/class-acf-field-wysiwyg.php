...
if (! class_exists('acf_field_wysiwyg')) {
    ...
    class acf_field_wysiwyg extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            // actions
            add_action('acf/enqueue_uploader', [$this, 'acf_enqueue_uploader']);
        }
        ...
        public function add_filters()
        {
            ...
            if (isset($GLOBALS['wp_embed'])) {
                add_filter('acf_the_content', [$GLOBALS['wp_embed'], 'run_shortcode'], 8);
                add_filter('acf_the_content', [$GLOBALS['wp_embed'], 'autoembed'], 8);
            }
        }
        ...
        public function get_toolbars()
        {
            ...
            // mce buttons (Full)
            $mce_buttons = ['formatselect', 'bold', 'italic', 'bullist', 'numlist', 'blockquote', 'alignleft', 'aligncenter', 'alignright', 'link', 'wp_more', 'spellchecker', 'fullscreen', 'wp_adv'];
            $mce_buttons_2 = ['strikethrough', 'hr', 'forecolor', 'pastetext', 'removeformat', 'charmap', 'outdent', 'indent', 'undo', 'redo', 'wp_help'];

            // mce buttons (Basic)
            $teeny_mce_buttons = ['bold', 'italic', 'underline', 'blockquote', 'strikethrough', 'bullist', 'numlist', 'alignleft', 'aligncenter', 'alignright', 'undo', 'redo', 'link', 'fullscreen'];
         ...
         * @return void
         */
        public function acf_enqueue_uploader()
        {
