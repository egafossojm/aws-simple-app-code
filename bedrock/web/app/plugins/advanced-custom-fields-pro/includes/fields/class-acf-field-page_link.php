...
if (! class_exists('acf_field_page_link')) {
    ...
    class acf_field_page_link extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            // extra
            add_action('wp_ajax_acf/fields/page_link/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/page_link/query', [$this, 'ajax_query']);
            add_filter('acf/conditional_logic/choices', [$this, 'render_field_page_link_conditional_choices'], 10, 3);
        }
