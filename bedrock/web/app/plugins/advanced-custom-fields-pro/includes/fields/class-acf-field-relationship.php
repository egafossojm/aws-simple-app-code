...
if (! class_exists('acf_field_relationship')) {
    ...
    class acf_field_relationship extends acf_field
    {
        ...
        public function initialize()
        {
            ...
            add_filter('acf/conditional_logic/choices', [$this, 'render_field_relation_conditional_choices'], 10, 3);

            // extra
            add_action('wp_ajax_acf/fields/relationship/query', [$this, 'ajax_query']);
            add_action('wp_ajax_nopriv_acf/fields/relationship/query', [$this, 'ajax_query']);
        }
