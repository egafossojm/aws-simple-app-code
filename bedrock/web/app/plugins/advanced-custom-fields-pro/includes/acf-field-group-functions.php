...
{
    $default_field_group_settings_tabs = [
        'location_rules' => __('Location Rules', 'acf'),
        'presentation' => __('Presentation', 'acf'),
        'group_settings' => __('Group Settings', 'acf'),
    ];

    $field_group_settings_tabs = (array) apply_filters('acf/field_group/additional_group_settings_tabs', []);
 ...
 * @since 6.2.8
 *
 * @param  int  $post_id  The post ID of the field group.
