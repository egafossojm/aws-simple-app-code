    ...
    class acf_revisions
    {
        ...
        public function __construct()
        {
            ...
            if (version_compare(get_bloginfo('version'), '6.4', '>=')) {
                add_action('_wp_put_post_revision', [$this, 'maybe_save_revision'], 10, 2);
                add_filter('wp_save_post_revision_post_has_changed', [$this, 'check_acf_fields_have_changed'], 9, 3);
                add_filter('wp_post_revision_meta_keys', [$this, 'wp_post_revision_meta_keys']);
         ...
         * @since 6.2.6
         *
         * @param  bool  $post_has_changed  True if the post has changed, false if not.
         ...
         * @since 6.2.6
         *
         * @param  int  $revision_id  The ID of the revision that was just created.
         ...
         * @date    19/09/13
         *
         * @param  bool  $return  defaults to true
