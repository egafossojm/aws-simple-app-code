...
if (! class_exists('ACF_Assets')) {
    ...
    class ACF_Assets
    {
        ...
        public function register_scripts()
        {
            ...
            // Register scripts.
            wp_register_script('acf', acf_get_url('assets/build/js/acf'.$suffix.'.js'), ['jquery'], $version);
            wp_register_script('acf-input', acf_get_url('assets/build/js/acf-input'.$suffix.'.js'), ['jquery', 'jquery-ui-sortable', 'jquery-ui-resizable', 'acf', 'wp-a11y'], $version);
            wp_register_script('acf-field-group', acf_get_url('assets/build/js/acf-field-group'.$suffix.'.js'), ['acf-input'], $version);
            wp_register_script('acf-internal-post-type', acf_get_url('assets/build/js/acf-internal-post-type'.$suffix.'.js'), ['acf-input'], $version);
            wp_register_script('acf-escaped-html-notice', acf_get_url('assets/build/js/acf-escaped-html-notice'.$suffix.'.js'), ['jquery'], $version, true);

            // Register styles.
            wp_register_style('acf-global', acf_get_url('assets/build/css/acf-global.css'), ['dashicons'], $version);
            wp_register_style('acf-input', acf_get_url('assets/build/css/acf-input.css'), ['acf-global'], $version);
            wp_register_style('acf-field-group', acf_get_url('assets/build/css/acf-field-group.css'), ['acf-input'], $version);
