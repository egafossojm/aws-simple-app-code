 ...
 * @return array
 */
function acf_get_internal_post_type_posts($post_type = 'acf-field-group', $filter = [])
{
    $posts = [];
    $instance = acf_get_internal_post_type_instance($post_type);
 ...
 * @return array
 */
function acf_filter_internal_post_type_posts($posts, $args = [], $post_type = 'acf-field-group')
{
    $filtered = [];
    $instance = acf_get_internal_post_type_instance($post_type);
 ...
 * @return array
 */
function acf_prepare_internal_post_type_for_export($post = [], $post_type = 'acf-field-group')
{
    $instance = acf_get_internal_post_type_instance($post_type);
 ...
 * @return array
 */
function acf_prepare_internal_post_type_for_import($post = [], $post_type = 'acf-field-group')
{
    $instance = acf_get_internal_post_type_instance($post_type);
...
function acf_get_combined_post_type_settings_tabs()
{
    ...
    $additional_post_type_tabs = (array) apply_filters('acf/post_type/additional_settings_tabs', []);
...
function acf_get_combined_taxonomy_settings_tabs()
{
    ...
    $additional_taxonomy_tabs = (array) apply_filters('acf/taxonomy/additional_settings_tabs', []);
...
{
    $default_options_page_tabs = [
        'visibility' => __('Visibility', 'acf'),
        'labels' => __('Labels', 'acf'),
        'permissions' => __('Permissions', 'acf'),
    ];

    $additional_options_page_tabs = (array) apply_filters('acf/ui_options_page/additional_settings_tabs', []);
