...
acf_add_filter_variations('acf/rest/get_field_schema', ['type', 'name', 'key'], 1);
...
acf_add_filter_variations('acf/rest/get_field_links', ['type', 'name', 'key'], 2);
...
acf_add_filter_variations('acf/rest/format_value_for_rest', ['type', 'name', 'key'], 2);
