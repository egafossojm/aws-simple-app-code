...
if (! class_exists('ACF_Media')) {
    ...
    class ACF_Media
    {
        ...
        public function handle_upload_prefilter($file)
        {
            ...
            add_filter('image_size_names_choose', [$this, 'image_size_names_choose'], 10, 1);
        ...
        public function wp_ajax_query_attachments()
        {
            if ($this->get_source_field()) {
                ...
                add_filter('wp_prepare_attachment_for_js', [$this, 'clear_acf_errors_for_core_requests'], 5, 3);
            }
        }
         ...
         * @return array
         */
        public function clear_acf_errors_for_core_requests($response, $attachment, $meta)
        {
