...
if (! class_exists('ACF_Admin')) {
    ...
    class ACF_Admin
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_notices', [$this, 'maybe_show_escaped_html_notice']);
            add_action('admin_init', [$this, 'dismiss_escaped_html_notice']);
            add_action('admin_init', [$this, 'clear_escaped_html_log']);
            add_filter('parent_file', [$this, 'ensure_menu_selection']);
            add_filter('submenu_file', [$this, 'ensure_submenu_selection']);
        }
        ...
        public function setup_help_tab()
        {
            ...
            $screen->add_help_tab(
                [
                    ...
                    'content' => '<p><strong>'.__('Overview', 'acf').'</strong></p>'.
            ...
            $screen->add_help_tab(
                [
                    ...
                    'content' => '<p><strong>'.__('Help & Support', 'acf').'</strong></p>'.
        ...
        public function maybe_show_escaped_html_notice()
        {
            ...
            if (! empty($escaped)) {
                acf_get_view('escaped-html-notice', ['acf_escaped' => $escaped]);
            }
        }
