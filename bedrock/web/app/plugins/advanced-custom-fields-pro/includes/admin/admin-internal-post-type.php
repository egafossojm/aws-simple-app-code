...
if (! class_exists('ACF_Admin_Internal_Post_Type')) {
    ...
    class ACF_Admin_Internal_Post_Type
    {
        ...
        public function __construct()
        {
            ...
            add_action('wp_ajax_acf/link_field_groups', [$this, 'ajax_link_field_groups']);
        ...
        public function ajax_link_field_groups()
        {
            ...
            $instructions = sprintf(
                ...
                $post_type === 'acf-post-type' ? __('post type', 'acf') : __('taxonomy', 'acf')
            );
