...
if (! class_exists('ACF_Admin_Post_Type')) {
    ...
    class ACF_Admin_Post_type extends ACF_Admin_Internal_Post_Type
    {
        ...
        public function admin_head()
        {
            ...
            // metaboxes.
            add_meta_box('acf-basic-settings', __('Basic Settings', 'acf'), [$this, 'mb_basic_settings'], 'acf-post-type', 'normal', 'high');
            add_meta_box('acf-advanced-settings', __('Advanced Settings', 'acf'), [$this, 'mb_advanced_settings'], 'acf-post-type', 'normal', 'high');
            ...
            add_filter('get_user_option_screen_layout_acf-post-type', [$this, 'screen_layout'], 10, 1);
            add_filter('get_user_option_metaboxhidden_acf-post-type', [$this, 'force_basic_settings'], 10, 1);
            add_filter('get_user_option_closedpostboxes_acf-post-type', [$this, 'force_basic_settings'], 10, 1);
            add_filter('get_user_option_closedpostboxes_acf-post-type', [$this, 'force_advanced_settings'], 10, 1);
