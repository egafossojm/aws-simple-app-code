...
if (! class_exists('ACF_Admin_Field_Groups')) {
    ...
    class ACF_Admin_Field_Groups extends ACF_Admin_Internal_Post_Type_List
    {
        ...
        {
            add_action('admin_menu', [$this, 'admin_menu'], 7);
            add_action('load-edit.php', [$this, 'handle_redirection']);
            add_action('post_class', [$this, 'get_admin_table_post_classes'], 10, 3);
        ...
        public function render_admin_table_column_num_fields($field_group)
        {
            ...
            if (empty($field_group['ID']) || get_post_status($field_group['ID']) === 'trash') {
         ...
         * @param  int  $post_id  The ID of the field group.
         * @return array
         */
