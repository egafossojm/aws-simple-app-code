...
if (! class_exists('ACF_Admin_Internal_Post_Type_List')) {
    ...
    class ACF_Admin_Internal_Post_Type_List
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_footer', [$this, 'include_pro_features']);
        ...
        public function current_screen()
        {
            ...
            add_filter("views_edit-{$this->post_type}", [$this, 'admin_table_views'], 10, 1);
            add_filter("manage_{$this->post_type}_posts_columns", [$this, 'admin_table_columns'], 10, 1);
            add_action("manage_{$this->post_type}_posts_custom_column", [$this, 'admin_table_columns_html'], 10, 2);
            add_filter('display_post_states', [$this, 'display_post_states'], 10, 2);
            add_filter("bulk_actions-edit-{$this->post_type}", [$this, 'admin_table_bulk_actions'], 10, 1);
        ...
        public function page_row_actions($actions, $post)
        {
            ...
            } elseif ($this->post_type === 'acf-taxonomy') {
            ...
            } elseif ($this->post_type === 'acf-ui-options-page') {
            ...
            $order = ['edit', 'acfduplicate', $activate_deactivate_action, 'trash'];
        ...
        {
            if (! in_array($this->view, ['sync', 'trash'], true)) {
        ...
        public function check_activate()
        {
            ...
            } elseif (! empty($args['post']) && $args['action2'] === 'acfactivate') {
        ...
        public function check_deactivate()
        {
            ...
            } elseif (! empty($args['post']) && $args['action2'] === 'acfdeactivate') {
        ...
        public function check_duplicate()
        {
            ...
            } elseif (! empty($args['post']) && $args['action2'] === 'acfduplicate') {
        ...
        public function check_sync()
        {
            ...
            } elseif (! empty($args['post']) && $args['action2'] === 'acfsync') {
