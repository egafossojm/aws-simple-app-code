    ...
    class ACF_Admin_Tool_Export extends ACF_Admin_Tool
    {
        ...
        public function html_generate()
        {
            ...
            foreach ($to_export as $post_type => $posts) {
                ...
                } elseif ($post_type === 'acf-post-type' || $post_type === 'acf-taxonomy') {
                ...
                if (in_array($post_type, ['acf-post-type', 'acf-taxonomy', 'acf-field-group', 'acf-ui-options-page'], true)) {
                    echo "} );\r\n\r\n";
                }
        ...
        {
            $key_names = ['keys', 'taxonomy_keys', 'post_type_keys', 'ui_options_page_keys'];
            $all_keys = [];
