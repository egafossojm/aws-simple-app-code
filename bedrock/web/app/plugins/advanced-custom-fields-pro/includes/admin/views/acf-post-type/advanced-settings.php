...
foreach (acf_get_combined_post_type_settings_tabs() as $tab_key => $tab_label) {
    ...
    switch ($tab_key) {
        case 'general':
            ...
            $acf_selected_supports = is_array($acf_post_type['supports']) ? $acf_post_type['supports'] : [];
            ...
            acf_render_field_wrap(['type' => 'seperator']);
        ...
        case 'visibility':
            ...
            if (is_string($acf_post_type['menu_icon'])) {
                ...
                if (strpos($acf_post_type['menu_icon'], 'dashicons-') !== false) {
                    $acf_post_type['menu_icon'] = [
                        'type' => 'dashicons',
