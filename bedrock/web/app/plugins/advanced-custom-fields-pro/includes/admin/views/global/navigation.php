...
$core_tabs_classes = ['acf-field-group', 'acf-post-type', 'acf-taxonomy'];
$acf_more_items_classes = ['acf-ui-options-page', 'acf-tools', 'acf-settings-updates'];
...
if (isset($submenu[$parent_slug])) {
    foreach ($submenu[$parent_slug] as $i => $sub_item) {
        ...
        if (! strpos($sub_item[2], '.php')) {
            $menu_item['url'] = add_query_arg(['page' => $sub_item[2]], $parent_slug);
        ...
        if (in_array($menu_item['class'], $core_tabs_classes, true)) {
            ...
            if (in_array($menu_item['class'], ['acf-post-type', 'acf-taxonomy'], true)) {
            ...
            if ($menu_item['class'] === 'acf_options_preview') {
                continue;
            }
