...
if (current_user_can(acf_get_setting('capability'))) {
    ...
    $acf_dismiss_url = add_query_arg(['acf-dismiss-esc-html-notice' => wp_create_nonce('acf/dismiss_escaped_html_notice')]);
...
<div class="acf-admin-notice notice acf-escaped-html-notice <?php echo esc_attr($acf_class); ?>">
	...
	<div class="acf-error-details" style="display: none; list-style: disc; margin-left: 14px;">
		...
		<?php
	    $acf_clear_logs_url = add_query_arg(['acf-clear-esc-html-log' => wp_create_nonce('acf/clear_escaped_html_log')]);
