...
if (! class_exists('ACF_Admin_Options_Preview')) {
    class ACF_Admin_Options_Preview
    {
        ...
        public function admin_menu()
        {
            ...
            $page = add_submenu_page('edit.php?post_type=acf-field-group', __('Options Pages', 'acf'), __('Options Pages', 'acf'), acf_get_setting('capability'), 'acf_options_preview', [$this, 'render']);
