 ...
 * @param  bool  $dismissable  Is this notification dismissible (default true) (since 5.11.0)
 * @param  bool  $persisted  Store once a notice has been dismissed per user and prevent showing it again. (since 6.1.0)
 * @return ACF_Admin_Notice
 */
