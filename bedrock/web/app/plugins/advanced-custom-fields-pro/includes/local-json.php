...
if (! class_exists('ACF_Local_JSON')) {
    ...
    class ACF_Local_JSON
    {
        ...
        public function __construct()
        {
            ...
            add_action('acf/update_post_type', [$this, 'update_internal_post_type']);
            add_action('acf/untrash_post_type', [$this, 'update_internal_post_type']);
            add_action('acf/trash_post_type', [$this, 'delete_internal_post_type']);
            add_action('acf/delete_post_type', [$this, 'delete_internal_post_type']);
            add_action('acf/update_taxonomy', [$this, 'update_internal_post_type']);
            add_action('acf/untrash_taxonomy', [$this, 'update_internal_post_type']);
            add_action('acf/trash_taxonomy', [$this, 'delete_internal_post_type']);
            add_action('acf/delete_taxonomy', [$this, 'delete_internal_post_type']);

            // Include fields.
            add_action('acf/include_fields', [$this, 'include_fields']);
            add_action('acf/include_post_types', [$this, 'include_post_types']);
            add_action('acf/include_taxonomies', [$this, 'include_taxonomies']);
        }
         ...
         * @return array
         */
        public function get_save_paths($key = '', $post = [])
        {
         ...
         * @return array
         */
        public function scan_field_groups()
        {
         ...
         * @return bool
         */
        public function delete_file($key, $post = [])
        {
            $paths = $this->get_save_paths($key, $post);
            $filename = $this->get_filename($key, $post);
