...
if (! class_exists('ACF_Form_Gutenberg')) {
    ...
    class ACF_Form_Gutenberg
    {
        ...
        public function __construct()
        {
            ...
            add_action('acf/validate_save_post', [$this, 'acf_validate_save_post'], 999);
        }
        ...
        public function enqueue_block_editor_assets()
        {
            ...
            add_action('add_meta_boxes', [$this, 'add_meta_boxes'], 20, 0);

            // Call edit_form_after_title manually.
            add_action('block_editor_meta_box_hidden_fields', [$this, 'block_editor_meta_box_hidden_fields']);

            // Customize editor metaboxes.
            add_filter('filter_block_editor_meta_boxes', [$this, 'filter_block_editor_meta_boxes']);
         ...
         * @return void
         */
        public function block_editor_meta_box_hidden_fields()
        {
         ...
         */
        public function filter_block_editor_meta_boxes($wp_meta_boxes)
        {
            ...
            if (isset($wp_meta_boxes[$current_screen->id]['acf_after_title'])) {
                ...
                add_filter('get_user_option_meta-box-order_'.$current_screen->id, [$this, 'modify_user_option_meta_box_order']);
            }
