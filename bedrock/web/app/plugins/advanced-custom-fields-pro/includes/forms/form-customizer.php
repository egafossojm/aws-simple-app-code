...
if (! class_exists('acf_form_customizer')) {
    ...
    class acf_form_customizer
    {
        ...
        public function __construct()
        {
            ...
            add_action('customize_preview_init', [$this, 'customize_preview_init'], 1, 1);
            add_action('customize_save', [$this, 'customize_save'], 1, 1);

            // save
            add_filter('widget_update_callback', [$this, 'save_widget'], 10, 4);
        }
        ...
        public function customize_controls_init()
        {
            ...
            // actions
            add_action('acf/input/admin_footer', [$this, 'admin_footer'], 1);
        }
        ...
        public function customize_save($customizer)
        {
            ...
            foreach ($settings as $setting) {
                ...
                add_filter('pre_update_option_'.$id_data['base'], [$this, 'pre_update_option'], 10, 3);
            }
        }
