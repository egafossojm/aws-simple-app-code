...
if (! class_exists('ACF_Form_Post')) {
    ...
    class ACF_Form_Post
    {
        ...
        public function __construct()
        {
            ...
            add_action('load-post.php', [$this, 'initialize']);
            add_action('load-post-new.php', [$this, 'initialize']);

            // save
            add_filter('wp_insert_post_empty_content', [$this, 'wp_insert_post_empty_content'], 10, 2);
        ...
        public function initialize()
        {
            ...
            $restricted = array_merge($acf_post_types, ['acf-taxonomy', 'attachment']);
        ...
        public function add_meta_boxes($post_type, $post)
        {
            ...
            if ($field_groups) {
                foreach ($field_groups as $field_group) {
                    ...
                    // Add the meta box.
                    add_meta_box($id, acf_esc_html($title), [$this, 'render_meta_box'], $post_type, $context, $priority, ['field_group' => $field_group]);
                }
        ...
        public function allow_save_post($post)
        {
            ...
            // restrict post types
            $restrict = ['auto-draft', 'revision', 'acf-field', 'acf-field-group'];
