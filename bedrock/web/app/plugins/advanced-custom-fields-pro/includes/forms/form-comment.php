...
if (! class_exists('acf_form_comment')) {
    ...
    class acf_form_comment
    {
        ...
        public function __construct()
        {
            ...
            // render
            add_filter('comment_form_field_comment', [$this, 'comment_form_field_comment'], 999, 1);

            // add_action( 'comment_form_logged_in_after',       array( $this, 'add_comment') );
            // add_action( 'comment_form',                       array( $this, 'add_comment') );
            // save
            add_action('edit_comment', [$this, 'save_comment'], 10, 1);
            add_action('comment_post', [$this, 'save_comment'], 10, 1);
        }
        ...
        public function admin_enqueue_scripts()
        {
            ...
            add_action('add_meta_boxes_comment', [$this, 'edit_comment'], 10, 1);
        }
         ...
         * @return $post_id (int)
         */
        public function comment_form_field_comment($html)
        {
