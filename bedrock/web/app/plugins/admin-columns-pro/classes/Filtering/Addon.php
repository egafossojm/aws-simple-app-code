...
class Addon implements AC\Registrable
{
    ...
    public function register()
    {
        ...
        add_action('ac/settings/scripts', [$this, 'settings_scripts']);
    ...
    public function ajax_update_dropdown_cache()
    {
        ...
        $input = (object) filter_input_array(INPUT_POST, [
    ...
    public function table_screen(AC\ListScreen $list_screen)
    {
        ...
        $assets[] = new ACP\Asset\Script('acp-filtering-table', $location->with_suffix('assets/filtering/js/table.js'), ['jquery', 'jquery-ui-datepicker']);
    ...
    public function settings_scripts()
    {
        ...
        $script = new ACP\Asset\Script('acp-filtering-settings', $location->with_suffix('assets/filtering/js/settings.js'), ['jquery']);
        $script->enqueue();
    }
    ...
    public function handle_filtering(AC\ListScreen $list_screen)
    {
        foreach ($list_screen->get_columns() as $column) {
            ...
            if ($model && $model->is_active() && $model->get_filter_value() !== false) {
