...
class Feedback implements Registrable
{
    ...
    {
        add_action('ac/admin/render', [$this, 'feedback_render']);
    ...
    {
        wp_enqueue_style('acp-feedback', ACP()->get_url().'assets/core/css/feedback.css', [], ACP()->get_version());
        wp_enqueue_script('acp-feedback', ACP()->get_url().'assets/core/js/feedback.js', [], ACP()->get_version());
