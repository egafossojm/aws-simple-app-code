...
class License extends AC\Admin\Section\Custom
{
    ...
    {
        wp_enqueue_style('acp-license-manager', ACP()->get_url().'assets/core/css/license-manager.css', [], ACP()->get_version());
        wp_enqueue_script('acp-license-manager', ACP()->get_url().'assets/core/js/license-manager.js', ['jquery'], ACP()->get_version());
    }
    ...
    private function activate_license($license_key)
    {
        ...
        if ($response->get('activated') === null) {
    ...
    private function deactivate_license()
    {
        ...
        if ($response->get('deactivated') === null) {
            return new WP_Error('error', __('Wrong response from API.', 'codepress-admin-columns'));
        }
