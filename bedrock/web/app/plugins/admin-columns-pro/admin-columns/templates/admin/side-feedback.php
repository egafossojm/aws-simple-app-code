	...
	<div id="feedback-rate">
		<div class="inside">
			...
			<ul class="share">
				...
				<li>
					<a href="<?php echo esc_url(add_query_arg(['hashtags' => 'admincolumns', 'text' => urlencode(__("I'm using Admin Columns for WordPress!", 'codepress-admin-columns')), 'url' => urlencode('http://wordpress.org/plugins/codepress-admin-columns/'), 'via' => ac_get_twitter_handle()], 'https://twitter.com/intent/tweet')); ?>" target="_blank">
