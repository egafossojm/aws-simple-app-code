...
class AdminColumns extends Plugin
{
    ...
    private function __construct()
    {
        ...
        add_action('ac/screen/quick_edit', [$this, 'init_table_on_quick_edit']);
    ...
    public function redirect_after_status_change($location)
    {
        ...
        if ($pagenow !== 'plugins.php' || ! filter_input(INPUT_GET, 'ac-redirect') || filter_input(INPUT_GET, 'error')) {
            return $location;
        }
