...
final class Screen implements Registrable
{
    ...
    {
        if (filter_input(INPUT_GET, 'ac_action') !== 'first-visit') {
            return;
        }
    ...
    public function set_primary_column($default)
    {
        if ($this->list_screen) {
            ...
            foreach ($this->list_screen->get_columns() as $column) {
                if ($column->get_type() == 'column-actions') {
            ...
            if ($this->list_screen instanceof ListScreen\Post && $default !== 'title') {
            ...
            if ($this->list_screen instanceof ListScreen\Comment && $default !== 'comment') {
