...
class Addons extends Page implements AC\Registrable
{
    ...
    {
        wp_enqueue_style('ac-admin-page-addons', AC()->get_url().'assets/css/admin-page-addons.css', [], AC()->get_version());
        wp_enqueue_script('ac-admin-page-addons', AC()->get_url().'assets/js/admin-page-addons.js', ['jquery'], AC()->get_version());
