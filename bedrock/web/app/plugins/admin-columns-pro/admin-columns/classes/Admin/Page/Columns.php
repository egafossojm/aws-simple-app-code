...
class Columns extends Admin\Page implements Admin\Helpable, Registrable
{
    ...
    private function maybe_show_notice()
    {
        ...
        if (! $list_screen->get_stored_default_headings() && ! $list_screen->is_read_only()) {
            ...
            $first_visit_link = add_query_arg(['ac_action' => 'first-visit'], $list_screen->get_screen_link());
        ...
        ?>
			...
			<div class="ac-right">
                ...
                $label_main = __('Store settings', 'codepress-admin-columns');
					    ...
					    if (strlen($label_main) < 18 && ($truncated_label = $this->get_truncated_side_label($list_screen->get_label(), $label_main))) {
