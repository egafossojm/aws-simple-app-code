...
<?php
$yform->textinput('website_name', __('Website name', 'wordpress-seo'), ['placeholder' => get_bloginfo('name')]);
...
<?php
$yform->select('company_or_person', __('Company or person', 'wordpress-seo'), [
