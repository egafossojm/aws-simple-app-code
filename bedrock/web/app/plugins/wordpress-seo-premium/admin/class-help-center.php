...
class WPSEO_Help_Center
{
     ...
     * @param  bool  $premium_support  Show premium support tab.
     */
    ...
    protected function format_data(array $tabs)
    {
        ...
        foreach ($tabs as $tab) {
            $formatted_data['tabs'][$tab->get_name()] = [
                'label' => $tab->get_label(),
        ...
        $active_tab = ($active_tab === null) ? $tabs[0] : $active_tab;
        ...
        $formatted_data['contactSupportParagraphs'] = [
            [
                'image' => [
    ...
    protected function get_extra_tabs()
    {
        ...
        return array_map([$this, 'format_helpcenter_tab'], $help_center_items);
    }
    ...
    private function add_contact_support_item()
    {
        ...
        $contact_support_help_center_item = new WPSEO_Help_Center_Item(
            ...
            ['content' => $premium_popup->get_premium_message(false)],
            'dashicons-email-alt'
        );
