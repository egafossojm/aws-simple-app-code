...
class WPSEO_GSC implements WPSEO_WordPress_Integration
{
    ...
    public function register_hooks()
    {
        ...
        add_action('admin_init', [$this, 'register_gsc_notification']);
    ...
    public function display_table()
    {
        ...
        add_filter('views_'.$list_table->get_screen_id(), [$this->category_filter, 'as_array']);
    ...
    private function add_notification($message, $type)
    {
        Yoast_Notification_Center::get()->add_notification(
            new Yoast_Notification($message, ['type' => $type])
        );
    }
