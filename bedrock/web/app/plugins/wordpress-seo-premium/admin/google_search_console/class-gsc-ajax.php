...
class WPSEO_GSC_Ajax
{
    ...
    {
        add_action('wp_ajax_wpseo_mark_fixed_crawl_issue', [$this, 'ajax_mark_as_fixed']);
        add_action('wp_ajax_wpseo_dismiss_gsc', [$this, 'dismiss_notice']);
        add_action('wp_ajax_wpseo_save_auth_code', [$this, 'save_auth_code']);
        add_action('wp_ajax_wpseo_clear_auth_code', [$this, 'clear_auth_code']);
        add_action('wp_ajax_wpseo_get_profiles', [$this, 'get_profiles']);
    }
