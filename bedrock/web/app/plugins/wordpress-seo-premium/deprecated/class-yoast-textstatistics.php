...
{
    /**
     * @var string Used to hold character encoding to be used by object, if set
     *
     * @deprecated 3.0 Removed.
     */
    ...
    /**
     * @var string Efficiency: Is the MB String extension loaded ?
     *
     * @deprecated 3.0 Removed.
     */
    ...
    /**
     * @var bool Should the result be normalized ?
     *
     * @deprecated 3.0 Removed.
     */
