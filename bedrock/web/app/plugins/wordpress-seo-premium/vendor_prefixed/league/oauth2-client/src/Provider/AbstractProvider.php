...
abstract class AbstractProvider
{
     ...
     * @return string
     */
    abstract public function getResourceOwnerDetailsUrl(\YoastSEO_Vendor\League\OAuth2\Client\Token\AccessToken $token);
     ...
     * @throws IdentityProviderException
     */
    abstract protected function checkResponse(\YoastSEO_Vendor\Psr\Http\Message\ResponseInterface $response, $data);
     ...
     */
    abstract protected function createResourceOwner(array $response, \YoastSEO_Vendor\League\OAuth2\Client\Token\AccessToken $token);
