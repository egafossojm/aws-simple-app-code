...
class Ruckusing_Adapter_Sqlite3_TableDefinition extends \YoastSEO_Vendor\Ruckusing_Adapter_TableDefinition
{
    ...
    {
        $this->column($created_column_name, 'datetime', ['null' => \false, 'default' => 'CURRENT_TIMESTAMP']);
        $this->column($updated_column_name, 'datetime', ['null' => \false, 'default' => 'CURRENT_TIMESTAMP']);
    }
