...
class Ruckusing_FrameworkRunner
{
     ...
     * @var array
     */
    private $_opt_map = ['env' => 'development'];
    ...
    {
        \set_error_handler(['\YoastSEO_Vendor\Ruckusing_Exception', 'errorHandler'], \E_ALL);
        \set_exception_handler(['\YoastSEO_Vendor\Ruckusing_Exception', 'exceptionHandler']);
        //parse arguments
