...
class WPSEO_Redirect_Page
{
    ...
    public function enqueue_assets()
    {
        ...
        wp_enqueue_style('wpseo-premium-redirects', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/css/dist/premium-redirects-'.$version.WPSEO_CSSJS_SUFFIX.'.css', [], WPSEO_VERSION);
