...
class WPSEO_Premium_Metabox implements WPSEO_WordPress_Integration
{
    ...
    public function register_assets()
    {
        ...
        wp_register_style(WPSEO_Admin_Asset_Manager::PREFIX.'premium-metabox', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/css/dist/premium-metabox-'.$version.WPSEO_CSSJS_SUFFIX.'.css', [], WPSEO_VERSION);
    }
