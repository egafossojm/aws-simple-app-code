...
class WPSEO_Premium_Prominent_Words_Recalculation implements WPSEO_WordPress_Integration
{
    ...
    public function register_hooks()
    {
        ...
        add_action('wpseo_internal_linking', [$this, 'add_internal_linking_interface']);
    ...
    public function enqueue()
    {
        ...
        wp_register_script(WPSEO_Admin_Asset_Manager::PREFIX.'premium-site-wide-analysis', plugin_dir_url(WPSEO_PREMIUM_FILE).'/assets/js/dist/yoast-premium-site-wide-analysis-'.$version.WPSEO_CSSJS_SUFFIX.'.js', [], WPSEO_VERSION, true);
        ...
        if ($page === 'wpseo_dashboard') {
            ...
            wp_localize_script(WPSEO_Admin_Asset_Manager::PREFIX.'premium-site-wide-analysis', 'yoastSiteWideAnalysisData', ['data' => $data]);
        }
    }
