...
class WPSEO_Premium_GSC implements WPSEO_WordPress_Integration
{
    ...
    public function enqueue()
    {
        ...
        wp_register_script(WPSEO_Admin_Asset_Manager::PREFIX.'premium-gsc', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/js/dist/yoast-premium-gsc-'.$version.WPSEO_CSSJS_SUFFIX.'.js', ['jquery'], WPSEO_VERSION, true);
