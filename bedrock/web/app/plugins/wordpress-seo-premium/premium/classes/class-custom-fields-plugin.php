...
class WPSEO_Custom_Fields_Plugin
{
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script('wp-seo-premium-custom-fields-plugin', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/js/dist/wp-seo-premium-custom-fields-plugin-'.$version.WPSEO_CSSJS_SUFFIX.'.js', ['jquery'], WPSEO_VERSION);
    ...
    private function get_custom_field_names()
    {
        ...
        $post = $this->get_post();
        $options = get_option(WPSEO_Options::get_option_instance('wpseo_titles')->option_name, []);
