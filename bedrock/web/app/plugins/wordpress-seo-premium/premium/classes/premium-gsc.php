...
class WPSEO_Premium_GSC implements WPSEO_WordPress_Integration
{
    ...
    public function enqueue()
    {
        ...
        wp_register_script(WPSEO_Admin_Asset_Manager::PREFIX.'premium-gsc', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/js/dist/yoast-premium-gsc-'.$version.WPSEO_CSSJS_SUFFIX.'.js', ['jquery', 'yoast-seo-premium-commons'], WPSEO_VERSION, true);
        ...
        wp_localize_script(WPSEO_Admin_Asset_Manager::PREFIX.'premium-gsc', 'yoastPremiumGSC', ['data' => $data]);
    }
}
