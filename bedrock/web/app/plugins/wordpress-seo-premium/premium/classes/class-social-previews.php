...
class WPSEO_Social_Previews
{
    ...
    private function register_assets()
    {
        ...
        wp_register_script('yoast-social-preview', plugin_dir_url(WPSEO_PREMIUM_FILE).'assets/js/dist/yoast-premium-social-preview-'.$version.WPSEO_CSSJS_SUFFIX.'.js', [
            'jquery',
            'jquery-ui-core',
        ], WPSEO_VERSION);
        ...
        $deps = [WPSEO_Admin_Asset_Manager::PREFIX.'metabox-css'];
