...
class WPSEO_Premium
{
     ...
     * @var string
     */
    const PLUGIN_VERSION_NAME = '11.4';
    ...
    private function setup()
    {
        ...
        if (is_admin()) {
            ...
            add_action('wpseo_admin_page_meta_post_types', [$this, 'admin_page_meta_post_types_checkboxes'], 10, 2);

            // Add page analysis fields to variable array key patterns.
            add_filter('wpseo_option_titles_variable_array_key_patterns', [$this, 'add_variable_array_key_pattern']);
