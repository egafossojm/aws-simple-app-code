...
class WPSEO_Option_XML extends WPSEO_Option
{
    ...
    protected function __construct()
    {
        ...
        add_action('update_option_'.$this->option_name, ['WPSEO_Sitemaps_Cache', 'clear']);
    }
    ...
    public function enrich_defaults()
    {
        ...
        if (is_array($filtered_user_roles) && $filtered_user_roles !== []) {
        ...
        if (is_array($filtered_post_types) && $filtered_post_types !== []) {
        ...
        if (is_array($filtered_taxonomies) && $filtered_taxonomies !== []) {
