...
class WPSEO_Meta
{
     ...
     *
     * {@internal * - Titles, help texts, description text and option labels are added via a translate_meta_boxes() method
    ...
    public static function clean_up()
    {
        ...
        foreach (self::$meta_fields as $subset => $field_group) {
            foreach ($field_group as $key => $field_def) {
                ...
                } elseif (isset($field_def['options']) && is_array($field_def['options']) && $field_def['options'] !== []) {
     ...
     * @param  int  $post_id  The is of the post to which the keyword belongs.
     * @return array
     */
