...
class NameIdValidator implements NameIdValidatorInterface
{
    ...
    {
        if (Helper::validateWellFormedUriString($nameId->getFormat()) == false) {
    ...
    {
        if (Helper::validateRequiredString($nameId->getValue()) == false) {
        ...
        if (filter_var($nameId->getValue(), FILTER_VALIDATE_EMAIL) == false) {
    ...
    protected function validateKerberosFormat(AbstractNameID $nameId)
    {
        ...
        if (strpos($nameId->getValue(), '@') === false) {
    ...
    protected function validateTransientFormat(AbstractNameID $nameId)
    {
        ...
        if (Helper::validateIdString($nameId->getValue()) == false) {
            throw new LightSamlValidationException(
                sprintf(
