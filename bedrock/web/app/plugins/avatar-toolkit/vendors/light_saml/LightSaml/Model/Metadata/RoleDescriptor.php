...
abstract class RoleDescriptor extends AbstractSamlModel
{
    ...
    {
        if (is_array($this->contactPersons) == false) {
            $this->contactPersons = [];
        }
    ...
    {
        if (is_array($this->keyDescriptors) == false) {
            $this->keyDescriptors = [];
        }
    ...
    {
        if (is_array($this->organizations) == false) {
            $this->organizations = [];
        }
    ...
    {
        if (is_array($this->signatures) == false) {
            $this->signatures = [];
        }
