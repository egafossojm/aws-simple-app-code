...
class ProfileContext extends AbstractProfileContext
{
    ...
    public function getHttpRequest()
    {
        ...
        if ($httpRequestContext->getRequest() === null) {
    ...
    public function getInboundMessage()
    {
        ...
        if ($inboundContext->getMessage() === null) {
    ...
    public function getOutboundMessage()
    {
        ...
        if ($outboundContext->getMessage() === null) {
    ...
    public function getEndpoint()
    {
        ...
        if ($endpointContext->getEndpoint() === null) {
    ...
    public function getOwnEntityDescriptor()
    {
        ...
        if ($ownEntityContext->getEntityDescriptor() === null) {
    ...
    public function getPartyEntityDescriptor()
    {
        ...
        if ($partyEntityContext->getEntityDescriptor() === null) {
    ...
    {
        $partyEntityContext = $this->getPartyEntityContext();
        if ($partyEntityContext->getTrustOptions() === null) {
    ...
    public function getLogoutSsoSessionState()
    {
        ...
        if ($logoutContext->getSsoSessionState() == null) {
