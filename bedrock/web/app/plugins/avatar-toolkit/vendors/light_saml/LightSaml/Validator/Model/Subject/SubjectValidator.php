...
class SubjectValidator implements SubjectValidatorInterface
{
    ...
    {
        if ($subject->getNameID() == false &&
            $subject->getAllSubjectConfirmations() == false
        ) {
    ...
    {
        if (Helper::validateRequiredString($subjectConfirmation->getMethod()) == false) {
        ...
        if (Helper::validateWellFormedUriString($subjectConfirmation->getMethod()) == false) {
    ...
    protected function validateSubjectConfirmationData(SubjectConfirmationData $subjectConfirmationData)
    {
        if ($subjectConfirmationData->getRecipient()) {
            if (Helper::validateWellFormedUriString($subjectConfirmationData->getRecipient()) == false) {
