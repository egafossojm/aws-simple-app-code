<?php
/**
 * The default Custom Post Type for microsites
 *
 * @since Avatar 1.0.0
 */
class AK_Microsite
{
    ...
    public function __construct()
    {
        ...
        add_action('init', [$this, 'at_microsite_cpt'], 0);

        /* Add Taxomomy Custom Post Types */
        add_action('init', [$this, 'at_microsite_taxomomy'], 0);

        /* Add Meta Boxes Custom Post Types*/
        add_action('admin_init', [$this, 'at_microsite_meta_boxes']);
    }
    ...
    {
        $url = (class_exists('acf') and get_field('acf_microsite_slug', 'option')) ? get_field('acf_microsite_slug', 'option') : 'microsite';
    ...
    {
        return 'microsite-category';
    }

    public function at_get_name_singular()
    {
        return __('Microsite', 'avatar-toolkit');
    }

    public function at_get_name_plural()
    {
        return __('Microsites', 'avatar-toolkit');
    }
     ...
     * @since 1.0.0
     */
    public function at_microsite_cpt()
    {
     ...
     * @since 1.0.0
     */
    public function at_microsite_taxomomy() {}
     ...
     * @since 1.0.0
     */
    public function at_microsite_meta_boxes() {}
}
