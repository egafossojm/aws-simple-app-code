<?php
/**
 * The default Custom Post Type  for brands
 *
 * @since Avatar 1.0.0
 */
class AK_Brands
{
    ...
    public function __construct()
    {
        ...
        add_action('init', [$this, 'at_brands_cpt'], 0);

        /* Add Taxomomy Custom Post Types */
        add_action('init', [$this, 'at_brands_taxomomy'], 0);

        /* Add Meta Boxes Custom Post Types*/
        add_action('admin_init', [$this, 'at_brands_meta_boxes']);
    }
    ...
    {
        $url = (class_exists('acf') and get_field('acf_brand_knowledge_slug', 'option')) ? get_field('acf_brand_knowledge_slug', 'option') : 'brandknowledge';
    ...
    {
        return __('Brand', 'avatar-toolkit');
    }

    public function at_get_name_plural()
    {
        return __('Brands', 'avatar-toolkit');
    }
    ...
    public function at_brands_cpt()
    {
        ...
        $args = [
            ...
            'description' => __('Add Brand.', 'avatar-toolkit'),
            'labels' => $labels,
     ...
     * @since 1.0.0
     */
    public function at_brands_taxomomy() {}
     ...
     * @since 1.0.0
     */
    public function at_brands_meta_boxes() {}
}
