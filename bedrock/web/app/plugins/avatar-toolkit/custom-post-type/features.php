<?php
/**
 * The default Custom Post Type  for feature
 *
 * @since Avatar 1.0.0
 */
class AK_Features
{
    ...
    public function __construct()
    {
        ...
        add_action('init', [$this, 'at_features_cpt'], 0);

        /* Add Taxomomy Custom Post Types */
        add_action('init', [$this, 'at_features_taxomomy'], 0);

        /* Add Meta Boxes Custom Post Types*/
        add_action('admin_init', [$this, 'at_features_meta_boxes']);
    }
    ...
    {
        $url = (class_exists('acf') and get_field('acf_feature_slug', 'option')) ? get_field('acf_feature_slug', 'option') : 'feature';
    ...
    {
        return __('Feature', 'avatar-toolkit');
    }

    public function at_get_name_plural()
    {
        return __('Features', 'avatar-toolkit');
    }
     ...
     * @since 1.0.0
     */
    public function at_features_cpt()
    {
        ...
        $args = [
            ...
            'description' => __('Add Feature.', 'avatar-toolkit'),
            'labels' => $labels,
     ...
     * @since 1.0.0
     */
    public function at_features_taxomomy() {}
     ...
     * @since 1.0.0
     */
    public function at_features_meta_boxes() {}
}
