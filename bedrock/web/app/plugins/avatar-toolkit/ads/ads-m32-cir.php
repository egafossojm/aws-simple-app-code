 ...
 * ============================================================*/
if (! function_exists('at_m32_cir_variables')) {

    function at_m32_cir_variables()
    {
 ...
 * ============================================================*/
if (! function_exists('at_m32_cir_vars')) {

    function at_m32_cir_vars()
    {
        $at_js_code = get_field('acf_ad_code_site_cir', 'option');
...
if (! function_exists('at_get_cir_m32banner')) {

    function at_get_cir_m32banner($arr_m32_vars = [], $arr_avt_vars = [], $datam32ad = 'data-m32-ad')
    {
        ...
        $arr_m32_vars_default = [
            ...
            'dfpAdUnitPath' => get_field('acf_ad_code_site_cir', 'option').'/'.at_m32_get_ss(),
        ];
...
if (! function_exists('at_get_the_cir_m32banner')) {
    function at_get_the_cir_m32banner($arr_m32_vars = [], $arr_avt_vars = [], $datam32ad = 'data-m32-ad')
    {
        $html_banner = at_get_cir_m32banner($arr_m32_vars, $arr_avt_vars, $datam32ad);
        echo $html_banner;
    }
}
...
if (! function_exists('at_m32_get_cir_ss')) {
    function at_m32_get_cir_ss()
    {
        global $post;
        $data_tc_ad_zone = '-';
