...
class AS3CF_Local_To_S3 extends AS3CF_Filter
{
    ...
    {
        // EDD
        add_filter('edd_download_files', [$this, 'filter_edd_download_files']);
        // Customizer
        add_filter('theme_mod_background_image', [$this, 'filter_customizer_image']);
        add_filter('theme_mod_header_image', [$this, 'filter_customizer_image']);
        add_filter('customize_value_custom_css', [$this, 'filter_customize_value_custom_css'], 10, 2);
        add_filter('wp_get_custom_css', [$this, 'filter_wp_get_custom_css'], 10, 2);
        // Posts
        ...
        add_filter('as3cf_filter_post_local_to_s3', [$this, 'filter_post']); // Backwards compatibility
        add_filter('as3cf_filter_post_local_to_provider', [$this, 'filter_post']);
        // Widgets
        add_filter('widget_form_callback', [$this, 'filter_widget_display'], 10, 2);
        add_filter('widget_display_callback', [$this, 'filter_widget_display'], 10, 2);
    }
    ...
    public function filter_post_data($post)
    {
        ...
        if (is_array($pages) && count($pages) === 1 && ! empty($pages[0])) {
