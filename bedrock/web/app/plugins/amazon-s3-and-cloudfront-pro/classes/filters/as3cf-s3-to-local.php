...
class AS3CF_S3_To_Local extends AS3CF_Filter
{
    ...
    {
        // EDD
        add_filter('edd_metabox_save_edd_download_files', [$this, 'filter_edd_download_files']);
        // Customizer
        add_filter('pre_set_theme_mod_background_image', [$this, 'filter_customizer_image'], 10, 2);
        add_filter('pre_set_theme_mod_header_image', [$this, 'filter_customizer_image'], 10, 2);
        add_filter('pre_set_theme_mod_header_image_data', [$this, 'filter_header_image_data'], 10, 2);
        add_filter('update_custom_css_data', [$this, 'filter_update_custom_css_data'], 10, 2);
        // Posts
        add_filter('content_save_pre', [$this, 'filter_post']);
        add_filter('excerpt_save_pre', [$this, 'filter_post']);
        add_filter('as3cf_filter_post_s3_to_local', [$this, 'filter_post']); // Backwards compatibility
        add_filter('as3cf_filter_post_provider_to_local', [$this, 'filter_post']);
        // Widgets
        add_filter('widget_update_callback', [$this, 'filter_widget_save'], 10, 4);
    }
    ...
    protected function get_attachment_id_from_url($url)
    {
        ...
        foreach ($results as $result) {
            ...
            if (strpos($path, $meta['bucket']) !== false) {
