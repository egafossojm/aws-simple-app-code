...
class Sidebar_Presenter
{
    ...
    public function init($as3cf)
    {
        ...
        // AJAX
        add_action('wp_ajax_as3cfpro_update_sidebar', [$this, 'ajax_update_sidebar']);
        add_action('wp_ajax_as3cfpro_get_status', [$this, 'ajax_get_status']);
    }
    ...
    {
        $this->as3cf->enqueue_script('as3cf-pro-sidebar', 'assets/js/pro/sidebar', [
            'jquery',
            'as3cf-pro-script',
        ]);
