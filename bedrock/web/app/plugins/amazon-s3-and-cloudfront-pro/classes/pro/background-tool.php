...
abstract class Background_Tool extends Tool
{
    ...
    public function init()
    {
        ...
        add_action("wp_ajax_as3cfpro_{$this->tool_key}_start", [$this, 'ajax_handle_start']);
        add_action("wp_ajax_as3cfpro_{$this->tool_key}_cancel", [$this, 'ajax_handle_cancel']);
        add_action("wp_ajax_as3cfpro_{$this->tool_key}_pause_resume", [$this, 'ajax_handle_pause_resume']);
     ...
     * @return array
     */
    protected function create_tool_nonces($actions = ['start', 'pause_resume', 'cancel'])
    {
        $nonces = [];
