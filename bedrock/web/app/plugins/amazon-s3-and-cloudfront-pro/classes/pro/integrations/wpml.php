...
class Wpml extends Integration
{
    ...
    {
        add_action('wpml_media_create_duplicate_attachment', [$this, 'store_duplicate_attachment_ids'], 10, 2);
        add_action('as3cf_post_upload_attachment', [$this, 'duplicate_provider_meta'], 10, 2);
        add_filter('as3cf_pre_upload_attachment', [$this, 'duplicate_provider_meta_on_upload'], 10, 2);
    }
