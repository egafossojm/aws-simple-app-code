...
class Woocommerce extends Integration
{
    ...
    public function init()
    {
        ...
        add_action('wp_ajax_as3cf_woo_is_amazon_provider_attachment', [$this, 'ajax_is_amazon_provider_attachment']);
        add_action('woocommerce_process_product_file_download_paths', [$this, 'make_files_private_on_provider'], 10, 3);
        add_action('woocommerce_download_file_as3cf', [$this, 'download_file'], 10, 2);
        add_filter('woocommerce_file_download_method', [$this, 'add_download_method']);
    }
    ...
    public function admin_scripts()
    {
        ...
        if (in_array($screen->id, ['product', 'edit-product'])) {
            ...
            wp_enqueue_media();
            $this->as3cf->enqueue_script('as3cf-woo-script', 'assets/js/pro/integrations/woocommerce', [
                'jquery',
                'wp-util',
            ]);

            wp_localize_script('as3cf-woo-script', 'as3cf_woo', [
                'strings' => [
            ...
            */
            ...
            if (isset($atts['bucket']) && isset($atts['object'])) {
                ...
                try {
                    ...
                    $headers = apply_filters('as3cf_woocommerce_download_headers', ['ResponseContentDisposition' => 'attachment'], $file_data);
