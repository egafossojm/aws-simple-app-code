...
class Remove_Local_Files extends Background_Tool
{
    ...
    public function init()
    {
        ...
        add_action('as3cf_form_hidden_fields', [$this, 'render_hidden_field']);
        add_action('as3cf_after_settings', [$this, 'render_modal']);
        add_action('as3cf_pre_save_settings', [$this, 'maybe_start_tool_on_settings_save']);
    }
    ...
    public function load_assets()
    {
        ...
        $this->as3cf->enqueue_script('as3cf-pro-remove-local-files', 'assets/js/pro/tools/remove-local-files', [
            'jquery',
            'wp-util',
        ]);
    }
    ...
    {
        if (! isset($_POST['remove-local-files-prompt']) || (int) $_POST['remove-local-files-prompt'] === 0) {
            return;
        }
