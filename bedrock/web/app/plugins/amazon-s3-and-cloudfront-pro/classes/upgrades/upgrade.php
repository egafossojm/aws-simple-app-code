...
abstract class Upgrade
{
    ...
    public function __construct($as3cf)
    {
        ...
        add_action($this->cron_hook, [$this, 'do_upgrade']);

        add_action('as3cf_pre_settings_render', [$this, 'maybe_display_notices']);
    ...
    protected function init()
    {
        ...
        $this->save_session(['status' => self::STATUS_RUNNING]);
    ...
    {
        $action_url = $this->as3cf->get_plugin_page_url([
    ...
    protected function change_status_request($status)
    {
        ...
        $url = $this->as3cf->get_plugin_page_url([], 'self');
        wp_redirect($url);
        exit;
    }
    ...
    {
        return get_site_option('update_'.$this->upgrade_name.'_session', []);
    }
    ...
    protected function has_previous_upgrade_completed()
    {
        ...
        if ($previous_id !== 0 && (int) $this->get_saved_upgrade_id() < $previous_id) {
    ...
    {
        return get_site_transient($this->lock_key) !== false;
    }
    ...
    {
        return $this->get_upgrade_status() === self::STATUS_RUNNING;
    }
    ...
    protected function load_processesed_blog_ids()
    {
        ...
        return isset($session['processed_blog_ids']) ? $session['processed_blog_ids'] : [];
    }
