...
abstract class Provider
{
     ...
     * @return string
     */
    public function get_url_domain($bucket, $region = '', $expires = null, $args = [], $preview = false)
    {
     ...
     * @return array
     */
    abstract public function list_buckets(array $args = []);
     ...
     * @return bool
     */
    abstract public function does_object_exist($bucket, $key, array $options = []);
     ...
     * @return string
     */
    abstract public function get_object_url($bucket, $key, $expires, array $args = []);
     ...
     * @return array
     */
    abstract public function list_objects(array $args = []);
     ...
     * @return string
     */
    abstract protected function url_domain($domain, $bucket, $region = '', $expires = null, $args = [], $preview = false);
}
