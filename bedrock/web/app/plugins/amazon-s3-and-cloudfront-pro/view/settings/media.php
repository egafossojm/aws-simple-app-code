...
$this->render_view('notice', $remove_local_args); ?>
	...
	<?php
    $this->render_view('bucket-select', ['prefix' => $prefix, 'selected_provider' => $selected_provider, 'selected_region' => $selected_region, 'selected_bucket' => $selected_bucket]);

if ($this->get_provider()->needs_access_keys()) {
    ?>
		<p class="as3cf-need-help">
			<span class="dashicons dashicons-info"></span>
			<?php printf(__('Need help getting your Access Keys? <a href="%s">Check out the Quick Start Guide &rarr;</a>', 'amazon-s3-and-cloudfront'), $this->dbrains_url('/wp-offload-media/doc/quick-start-guide/', [
