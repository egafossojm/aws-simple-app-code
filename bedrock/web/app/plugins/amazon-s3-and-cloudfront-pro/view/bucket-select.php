...
?>
				<?php if (defined('AS3CF_REGION') || $region_required === true) { ?>
					<tr>
						<td>
						...
						<td>
							<?php
            if (! defined('AS3CF_REGION') && $this->get_defined_setting('region', false) === false) { ?>
...
?>
		...
		<?php if (defined('AS3CF_REGION') || $this->get_defined_setting('region', false) !== false || $region_required === true) { ?>
			<table class="form-table">
				<tr>
					<td>
						<?php _e('Region:', 'amazon-s3-and-cloudfront'); ?>
