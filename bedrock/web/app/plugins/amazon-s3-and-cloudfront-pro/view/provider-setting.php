...
<tr class="as3cf-provider <?php echo $tr_class; ?>">
	...
	<td>
		...
		<a href="<?php echo $this->get_plugin_page_url(['action' => 'change-provider']); ?>" id="<?php echo $prefix; ?>-change-provider" class="as3cf-change-provider"><?php _e('Change', 'amazon-s3-and-cloudfront'); ?></a>
	</td>
</tr>
