...
if (defined('AIOSEOP_VERSION')) {
     ...
     * @author Remy Perona
     */
    if (isset($all_in_one_seo_xml_options['modules']['aiosp_feature_manager_options']['aiosp_feature_manager_enable_sitemap']) && $all_in_one_seo_xml_options['modules']['aiosp_feature_manager_options']['aiosp_feature_manager_enable_sitemap'] === 'on') {
        /**
