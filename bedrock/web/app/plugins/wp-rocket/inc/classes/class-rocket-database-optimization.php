...
class Rocket_Database_Optimization
{
    ...
    public static function init()
    {
        ...
        add_action('init', [$self, 'database_optimization_scheduled']);
        add_action('rocket_database_optimization_time_event', [$self, 'process_handler']);
        add_action('update_option_'.WP_ROCKET_SLUG, [$self, 'save_optimize']);
        add_action('admin_post_rocket_optimize_database', [$self, 'optimize']);
        add_action('admin_notices', [$self, 'notice_process_running']);
        add_action('admin_notices', [$self, 'notice_process_complete']);
    }
