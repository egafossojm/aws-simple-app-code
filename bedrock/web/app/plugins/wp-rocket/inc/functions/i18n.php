...
function get_rocket_wpml_langs_for_admin_bar()
{
    ...
    if (isset($_GET['lang']) && $_GET['lang'] === 'all') {
        array_unshift(
            $langlinks, [
                'code' => 'all',
                'current' => $sitepress->get_current_language() === 'all',
...
function get_rocket_i18n_subdomains()
{
    ...
    if (rocket_is_plugin_active('sitepress-multilingual-cms/sitepress.php')) {
        ...
        if ((int) $option['language_negotiation_type'] === 2 || (int) $option['language_negotiation_type'] === 1 && $option['urls']['directory_for_default_language'] === true) {
