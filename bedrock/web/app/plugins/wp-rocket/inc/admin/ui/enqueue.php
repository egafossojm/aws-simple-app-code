...
{
    wp_enqueue_script('jquery-ui-sortable', null, ['jquery', 'jquery-ui-core'], null, true);
    wp_enqueue_script('jquery-ui-draggable', null, ['jquery', 'jquery-ui-core'], null, true);
    wp_enqueue_script('jquery-ui-droppable', null, ['jquery', 'jquery-ui-core'], null, true);
    wp_enqueue_script('options-wp-rocket', WP_ROCKET_ADMIN_UI_JS_URL.'options.js', ['jquery', 'jquery-ui-core'], WP_ROCKET_VERSION, true);
    wp_enqueue_script('fancybox-wp-rocket', WP_ROCKET_ADMIN_UI_JS_URL.'vendors/jquery.fancybox.pack.js', ['options-wp-rocket'], WP_ROCKET_VERSION, true);
    wp_enqueue_script('sweet-alert-wp-rocket', WP_ROCKET_ADMIN_UI_JS_URL.'vendors/sweetalert2.min.js', ['options-wp-rocket'], WP_ROCKET_VERSION, true);

    wp_enqueue_style('options-wp-rocket', WP_ROCKET_ADMIN_UI_CSS_URL.'options.css', [], WP_ROCKET_VERSION);
    wp_enqueue_style('fancybox-wp-rocket', WP_ROCKET_ADMIN_UI_CSS_URL.'fancybox/jquery.fancybox.css', ['options-wp-rocket'], WP_ROCKET_VERSION);
    ...
    wp_enqueue_style('sweet-alert-wp-rocket', WP_ROCKET_ADMIN_UI_CSS_URL.'sweetalert2.min.css', ['options-wp-rocket'], WP_ROCKET_VERSION);
}
...
{
    wp_enqueue_script('all-wp-rocket', WP_ROCKET_ADMIN_UI_JS_URL.'all.js', ['jquery'], WP_ROCKET_VERSION, true);
    wp_enqueue_style('admin-wp-rocket', WP_ROCKET_ADMIN_UI_CSS_URL.'admin.css', [], WP_ROCKET_VERSION);
}
